...
<?php require_once("includes/media-helper.php");  ?>
  ...
  <picture>
          <source
        srcset=
          "<?= getMediaPath('employment_hero_22') ?>" data-media-key="employment_hero_22"
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M1.5 12c.52-.37 1.035-.824 1.56-1.357a6.367 6.367 0 0 1 1.6-.836 6.19 6.19 0 0 0 1.546-.785c.45-.32.837-.658 1.158-1.01.313-.357.682-.76 1.136-1.083-.334-.315-.676-.67-1.02-.914l-.966-.69a7.973 7.973 0 0 1-.73-.584 16.705 16.705 0 0 0-1.117-.861C3.38 2.961 2.41 2.333 1.762 2"></path>
      ...
      <span class="">Job Opportunities</span>
        ...
        <h1 class="h1 text-primary text-balance">Job Opportunities</h1>
                  <h2 class="h3 text-primary mt-4">Join MidasTouch</h2>
                          <div class="prose mt-12">
						  <p>Are you passionate about shaping young minds and contributing to the future of education? <strong>At MidasTouch School of Excellence</strong>, we are always on the lookout for dedicated, dynamic, and innovative educators and staff members who are committed to making a difference.</p>
						  <p>We believe that a great school is built by great people. If you value <strong>creativity</strong>, <strong>collaboration</strong>, and <strong>continuous growth</strong>, we invite you to join our vibrant team of professionals. As part of<strong> MidasTouch</strong>, you will have the opportunity to work in an inspiring environment that encourages lifelong learning, holistic development, and academic excellence.</p>
...
<section
data-block="carousel"
class="relative overflow-hidden bg-white my-16 lg:my-32 "
x-data="swiper()"
data-slides="2"
data-loop="true"
data-centered="true"
...
data-effect="coverflow">
  <div class="container space-y-12">
    <div class="gap-y-4 text-center flex flex-col w-full items-center ">
            <h2 class="h2 text-line grow-0">Current Vacancies</h2>
                <div class="prose text-base font-normal max-w-2xl mx-auto"><p>Thank you for your interest in working at MidasTouch.</p>
<p>Our standard application form can be found as an downloadable document beneath the list of vacancies.</p>
<p>We have the following vacancies:<br /></p></div>
    </div>
    <div class="swiper overflow-visible">
      <div class="swiper-wrapper">
                  <div class="swiper-slide h-auto">
            <article class="bg-white text-secondary h-full shadow-md">
            <figure class="overflow-hidden group w-[calc(100%+3rem)] translate-x-[-1.5rem] rotate-2 u-mask-image">
            

  <picture>
         <source
        srcset=
          "<?= getMediaPath('employment_job_29') ?>" data-media-key="employment_job_29"
        media="(min-width: 1024px)"
        type="image/webp">
      <source
        srcset=
    ...
    <div class="p-5 lg:p-8">
        <h3 class="h2-sm">Head of Drama</h3>
        <div class="my-4 prose text-base font-normal"><p>Closing date noon, Tuesday 29th April 2025</p></div>
                        <a class="c-button-text" href="#" >Information Pack Head of Drama</a>
            </div>
</article>          </div>
                  <div class="swiper-slide h-auto">
            <article class="bg-white text-secondary h-full shadow-md">
  ...
  <picture>
          <source
        srcset=
          "<?= getMediaPath('employment_job_21') ?>" data-media-key="employment_job_21"
        media="(min-width: 1024px)"
        type="image/webp">
      <source
        srcset=
    ...
    <div class="p-5 lg:p-8">
        <h3 class="h2-sm">Head of Learning Enhancement</h3>
        <div class="my-4 prose text-base font-normal"><p>Closing date noon, Tuesday 29th April 2025</p></div>
                        <a class="c-button-text" href="#">Information Pack Head of Learning Enhancement</a>
            </div>
</article>          </div>
                  <div class="swiper-slide h-auto">
            <article class="bg-white text-secondary h-full shadow-md">
  ...
  <picture>
    ...
    <div class="p-5 lg:p-8">
        <h3 class="h2-sm">Lower KS2 Teacher</h3>
        <div class="my-4 prose text-base font-normal"><p>Closing date noon, Tuesday 29th April 2025</p></div>
                        <a class="c-button-text" href="#">Information Pack Lower KS2 Teacher</a>
            </div>
</article>          </div>
                  <div class="swiper-slide h-auto">
            <article class="bg-white text-secondary h-full shadow-md">
  ...
  <picture>
          <source
        srcset=
          "<?= getMediaPath('employment_job_23') ?>" data-media-key="employment_job_23"
        media="(min-width: 1024px)"
        type="image/webp">
      <source
        srcset=
    ...
    <div class="p-5 lg:p-8">
        <h3 class="h2-sm">Holiday Club Assistant Supervisor</h3>
        <div class="my-4 prose text-base font-normal"><p>Closing date noon, Tuesday 29th April 2025</p></div>
                        <a class="c-button-text" href="#">Information Pack Holiday Club Assistant Supervisor</a>
            </div>
</article>          </div>
                  <div class="swiper-slide h-auto">
            <article class="bg-white text-secondary h-full shadow-md">
  ...
  <picture>
          <source
        srcset=
          "<?= getMediaPath('employment_job_24') ?>" data-media-key="employment_job_24"
        media="(min-width: 1024px)"
        type="image/webp">
      <source
        srcset=
    ...
    <div class="p-5 lg:p-8">
        <h3 class="h2-sm">Sports Graduate (Hockey, Football or Netball Specialism)</h3>
        <div class="my-4 prose text-base font-normal"><p>Closing date noon, Friday 2nd May 2025</p></div>
                        <a class="c-button-text" href="#">Information Pack Sports Graduate</a>
            </div>
</article>          </div>
                  <div class="swiper-slide h-auto">
            <article class="bg-white text-secondary h-full shadow-md">
  ...
  <picture>
          <source
        srcset=
          "<?= getMediaPath('employment_job_25') ?>" data-media-key="employment_job_25"
        media="(min-width: 1024px)"
        type="image/webp">
      <source
        srcset=
    ...
    <div class="p-5 lg:p-8">
        <h3 class="h2-sm">Domestic Assistant and Lunchtime Supervisor</h3>
        <div class="my-4 prose text-base font-normal"><p>Closing date noon, Friday 25th April 2025</p></div>
                        <a class="c-button-text" href="#">Information Pack Domestic Assistant and Lunchtime Supervisor</a>
            </div>
</article>          </div>
              </div>
    </div>
  ...
  <button role="button" class="appearance-none w-8 text-primary fill-current focus:outline-none transition-transform duration-300 hover:translate-x-2" aria-label="Next item" data-swiper-navigation-next>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 37 33">
  <path id="ngzxyvosvq-Vector" fill="currentColor" d="M4.31 17.957c9.063-.069 18.093-.182 27.157-.25 1.957.004 1.715-2.739-.208-2.698-9.064.068-18.094.182-27.157.25-1.957-.005-1.75 2.693.207 2.698Z"></path>
  <path id="ngzxyvosvq-Vector_2" fill="currentColor" d="M20.052 28.432c5.305-4.215 10.524-8.435 15.829-12.65.714-.577.644-1.694-.228-2.162-4.319-2.377-9.443-8.782-14.138-10.487-1.802-.67-2.71 1.97-.904 2.564 4.488 1.579 9.317 7.93 13.469 10.221-.09-.734-.14-1.428-.229-2.162-5.305 4.215-10.524 8.434-15.829 12.65-1.427 1.153.603 3.18 2.03 2.026Z"></path>
</svg>
...
<section
data-block="documents"
class="bg-white my-16 lg:my-32 ">
  <div class="container space-y-24">
    <div class="gap-y-4 text-center flex flex-col w-full items-center ">
            <h2 class="h2 text-line grow-0">Documents</h2>
        </div>
          <div class="grid gap-8 md:grid-cols-3">
                  <a
  href="#"
  class="relative pb-4 flex flex-col gap-y-6 border-b group max-w-3xl group "
  data-sal="fade"
  data-sal-delay="0">
  <div class="relative flex-1">
    <h3 class="text-base font-normal">Child Protection Safeguarding and Welfare of Pupils Policy</h3>
      </div>
  <i class="relative block ml-auto w-12 text-primary rotate-90 group-hover:translate-y-2 transition-transform duration-300">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 37 33">
    <path id="Vector" fill="currentColor" d="M4.31 17.957c9.063-.069 18.093-.182 27.157-.25 1.957.004 1.715-2.739-.208-2.698-9.064.068-18.094.182-27.157.25-1.957-.005-1.75 2.693.207 2.698Z"/>
    <path id="Vector_2" fill="currentColor" d="M20.052 28.432c5.305-4.215 10.524-8.435 15.829-12.65.714-.577.644-1.694-.228-2.162-4.319-2.377-9.443-8.782-14.138-10.487-1.802-.67-2.71 1.97-.904 2.564 4.488 1.579 9.317 7.93 13.469 10.221-.09-.734-.14-1.428-.229-2.162-5.305 4.215-10.524 8.434-15.829 12.65-1.427 1.153.603 3.18 2.03 2.026Z"/>
</svg>
  </i>
</a>
                  <a
  ...
  data-sal-delay="100">
  <div class="relative flex-1">
    <h3 class="text-base font-normal">Application Form</h3>
      </div>
  <i class="relative block ml-auto w-12 text-primary rotate-90 group-hover:translate-y-2 transition-transform duration-300">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 37 33">
    <path id="Vector" fill="currentColor" d="M4.31 17.957c9.063-.069 18.093-.182 27.157-.25 1.957.004 1.715-2.739-.208-2.698-9.064.068-18.094.182-27.157.25-1.957-.005-1.75 2.693.207 2.698Z"/>
