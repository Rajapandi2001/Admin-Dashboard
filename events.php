 ...
 <body class="font-body text-base font-light lg:text-md text-secondary antialiased">
     ...
     <main class="" id="content">
         <section data-block="hero" class="h-screen" data-sal="fade">
             ...
             <picture>
                 <source srcset="<?= getMediaPath('events_hero_30') ?>" data-media-key="events_hero_30" media="(min-width: 1024px)" type="image/webp">
                 <source srcset="<?= getMediaPath('events_hero_30') ?>" data-media-key="events_hero_30" media="(min-width: 768px)" type="image/webp">
                 <source srcset="<?= getMediaPath('events_hero_30') ?>" data-media-key="events_hero_30" type="image/webp">
                 <source srcset="<?= getMediaPath('events_hero_30') ?>" data-media-key="events_hero_30" media="(min-width: 1024px)">
                 <source srcset="<?= getMediaPath('events_hero_30') ?>" data-media-key="events_hero_30" media="(min-width: 768px)">
                 <img src="<?= getMediaPath('events_hero_30') ?>" data-media-key="events_hero_30" class="w-full h-full object-cover " alt="Middles2" width="562"
                 ...
                 <div class="container-sm relative mb-12 md:mb-16 lg:-top-12 2xl:-top-24 lg:mb-8 2xl:mb-0 animate-fade-in"
                     ...
                     <nav class="mb-8">
                         <ul class="flex gap-4 items-center h5">
                             ...
                             <li>
                                 <span class="">Extra Curricular</span>
                             </li>
                         </ul>
                     </nav>
                     <h1 class="h1 text-primary text-balance">Extra Curricular</h1>
                     <h2 class="h3 text-primary mt-4">Something for everyone</h2>
                     <div class="prose mt-12">
                         <p>At<strong> Midas Touch School of Excellence</strong>, we believe that education extends
                             beyond the classroom. Our extra-curricular activities are designed to nurture creativity,
                             confidence, leadership, and teamwork among our students. These programs offer opportunities
                             for students to explore their passions, discover new interests, and develop essential life
                             skills.</p>
                     </div>
                 </div>
                     ...
                     <div class="container grid grid-cols-1 gap-8 lg:gap-x-0 items-center md:grid-cols-2">
                         <div class="relative order-2  pt-12 mb:pb-12 md:mb-24  ">
                             <div class="relative lg:max-w-sm lg:mx-auto gs-animate" data-anim-x="150">
                                 ...
                                 <h3 class="h2 text-line">See for yourself</h3>
                                 <div class="mt-4 prose text-base font-normal">
                                     <p>At Midas Touch School of Excellence, learning goes beyond the classroom. Our
                                         wide range of extracurricular activities sports, arts, music, and more help
                                         students explore their passions and talents. See for yourself how every child
                                         shines when given the chance to grow in every direction.
                                     </p>
                                 </div>
                                 <div class="mt-8 flex flex-wrap lg:flex-nowrap items-center gap-4">
                                     <a href="https://youtu.be/0PmsR3B_8xM?si=lg_9VrplJ-YYCj3z"
      ...
      <iframe 
        src='https://www.youtube.com/embed/0PmsR3B_8xM?si=lg_9VrplJ-YYCj3z&amp;autoplay=1' 
    ...
    `)">
                             ...
                             <figure
                                 ...
                                 <img src="<?= getMediaPath('events_gif_1') ?>" data-media-key="events_gif_1"
                             ...
                             <div class="w-[110%] md:w-[125%] -translate-x-[5%] md:-translate-x-1/4">
                                 ...
                                 <div class="-rotate-6  u-mask-border">
                                     <figure role="presentation" class="">
                                         ...
                                         <picture>
                                             <source srcset="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" media="(min-width: 1024px)"
                                                 type="image/webp">
                                             <source srcset="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" media="(min-width: 768px)"
                                                 type="image/webp">
                                             <source srcset="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" type="image/webp">
                                             <source srcset="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" media="(min-width: 1024px)">
                                             <source srcset="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" media="(min-width: 768px)">
                                             <img src="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17"
                                                 class="w-full h-full object-cover aspect-video u-mask-image "
                                                 alt="270521 edit1 044" width="420" height="236" loading="lazy">
                                         </picture>
                                     </figure>
                                     <a href="https://youtu.be/pBzOk9IqzLg?si=HMdCx6lf7ZX2JKRt"
      ...
      <iframe 
        src='https://www.youtube.com/embed/pBzOk9IqzLg?si=HMdCx6lf7ZX2JKRt&amp;autoplay=1'
    ...
    `)">
                 ...
                 <section data-block="videoGrid" class="container space-y-12 my-16 lg:my-32">
                     <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                         <h2 class="h2 text-line grow-0">Celebrations @MidasTouch</h2>
                     </div>
                     <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('events_gallery_21') ?>" data-media-key="events_gallery_21" media="(min-width: 1024px)"
                                         type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_21') ?>" data-media-key="events_gallery_21" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_21') ?>" data-media-key="events_gallery_21" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_21') ?>" data-media-key="events_gallery_21" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('events_gallery_21') ?>" data-media-key="events_gallery_21" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('events_gallery_21') ?>" data-media-key="events_gallery_21" class="w-full u-mask-image " alt="FAQs Emma"
    ...
    `)">
                             ...
                             <h3 class="h2-sm text-center">Midas Touch clubs &amp; activities</h3>
                         </article>
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('events_gallery_22') ?>" data-media-key="events_gallery_22" media="(min-width: 1024px)"
                                         type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_22') ?>" data-media-key="events_gallery_22" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_22') ?>" data-media-key="events_gallery_22" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_22') ?>" data-media-key="events_gallery_22" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('events_gallery_22') ?>" data-media-key="events_gallery_22" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('events_gallery_22') ?>" data-media-key="events_gallery_22" class="w-full u-mask-image " alt="FAQs Emma"
                                         width="410" height="225" loading="lazy">
                                 </picture>
                                 <a href="" role="button" class="absolute inset-0 grid place-content-center" x-data="{}"
                                     @click.prevent="$dispatch('open-lightbox', `
    ...
    `)">
                         ...
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('events_gallery_40') ?>" data-media-key="events_gallery_40" media="(min-width: 1024px)"
                                         type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_40') ?>" data-media-key="events_gallery_40" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_40') ?>" data-media-key="events_gallery_40" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_40') ?>" data-media-key="events_gallery_40" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('events_gallery_40') ?>" data-media-key="events_gallery_40" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('events_gallery_40') ?>" data-media-key="events_gallery_40" class="w-full u-mask-image " alt="FAQs Emma"
                                         width="410" height="225" loading="lazy">
                                 </picture>
                                 <a href="" role="button" class="absolute inset-0 grid place-content-center" x-data="{}"
                                     @click.prevent="$dispatch('open-lightbox', `
    ...
    `)">
                         ...
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('events_gallery_41') ?>" data-media-key="events_gallery_41" media="(min-width: 1024px)"
                                         type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_41') ?>" data-media-key="events_gallery_41" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_41') ?>" data-media-key="events_gallery_41" type="image/webp">
                                     <source srcset="<?= getMediaPath('events_gallery_41') ?>" data-media-key="events_gallery_41" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('events_gallery_41') ?>" data-media-key="events_gallery_41" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('events_gallery_41') ?>" data-media-key="events_gallery_41" class="w-full u-mask-image " alt="FAQs Emma"
                                         width="410" height="225" loading="lazy">
                                 </picture>
                                 <a href="" role="button" class="absolute inset-0 grid place-content-center" x-data="{}"
                                     @click.prevent="$dispatch('open-lightbox', `
    ...
    `)">
                 ...
                 <section data-block="text" class="relative bg-white pt-12 lg:pt-16 mb-12 lg:mb-16 ">
                     <div class="container-sm space-y-12">
                         <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                             <h2 class="h2 text-line grow-0">Clubs &amp; Activities</h2>
                         </div>
                         <div class="prose">
                             <p class="text-base">At MidasTouch School of Excellence, our clubs and activities provide
                                 students with opportunities to explore their interests beyond academics.</p>
                             <p class="text-base">From arts and science to leadership and community service, each club
                                 nurtures creativity, confidence, and collaboration.</p>
                             <p class="text-base">These platforms empower students to discover their passions and
                                 develop essential life skills in a fun and engaging environment.</p>
                         </div>
                     </div>
                 ...
                 <section data-block="text" class="relative bg-white pt-12 lg:pt-16 mb-12 lg:mb-16 ">
                     <div class="container-sm space-y-12">
                         <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                             <h2 class="h2 text-line grow-0">Fuelling up</h2>
                         </div>
                         <div class="prose">
                             <p class="text-base">we believe that education extends beyond the classroom. Our
                                 extra-curricular programs are designed to fuel students' passions, creativity, and
                                 confidence. From arts and sports to public speaking and innovation clubs, we nurture
                                 well-rounded individuals ready to take on the world.</p>
                         </div>
                     </div>
                     <div class="clear-both"></div>
                 </section>
                 <section data-block="gallery" class="bg-white my-12 lg:my-16 " x-data="swiper()" data-slides="1"
                     data-loop="true" data-space="32">
                     <div class="container space-y-12">
                         <div class="swiper u-mask-image">
                             <div class="swiper-wrapper">
                                 <div class="swiper-slide h-auto">
                                     ...
                                     <picture>
                                         <source srcset="<?= getMediaPath('events_carousel_13') ?>" data-media-key="events_carousel_13" media="(min-width: 1024px)"
                                             type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_13') ?>" data-media-key="events_carousel_13" media="(min-width: 768px)"
                                             type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_13') ?>" data-media-key="events_carousel_13" type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_13') ?>" data-media-key="events_carousel_13" media="(min-width: 1024px)">
                                         <source srcset="<?= getMediaPath('events_carousel_13') ?>" data-media-key="events_carousel_13" media="(min-width: 768px)">
                                         <img src="<?= getMediaPath('events_carousel_13') ?>" data-media-key="events_carousel_13" class="w-full h-full object-cover  "
                                             alt="Sporting achievements at midas touch" width="400" height=""
                                             loading="lazy">
                                     </picture>
                                 </div>
                                 <div class="swiper-slide h-auto">
                                     ...
                                     <picture>
                                         ...
                                         <source srcset="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" media="(min-width: 1024px)">
                                         <source srcset="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" media="(min-width: 768px)">
                                         <img src="<?= getMediaPath('events_gallery_17') ?>" data-media-key="events_gallery_17" class="w-full h-full object-cover  "
                                             alt="Sporting achievements at midas touch" width="400" height=""
                                             loading="lazy">
                                     </picture>
                                 </div>
                                 <div class="swiper-slide h-auto">
                                     ...
                                     <picture>
                                         <source srcset="<?= getMediaPath('events_carousel_9') ?>" data-media-key="events_carousel_9" media="(min-width: 1024px)"
                                             type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_9') ?>" data-media-key="events_carousel_9" media="(min-width: 768px)"
                                             type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_9') ?>" data-media-key="events_carousel_9" type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_9') ?>" data-media-key="events_carousel_9" media="(min-width: 1024px)">
                                         <source srcset="<?= getMediaPath('events_carousel_9') ?>" data-media-key="events_carousel_9" media="(min-width: 768px)">
                                         <img src="<?= getMediaPath('events_carousel_9') ?>" data-media-key="events_carousel_9" class="w-full h-full object-cover  "
                                             alt="Sporting achievements at midas touch" width="400" height=""
                                             loading="lazy">
                                     </picture>
                                 </div>
                                 <div class="swiper-slide h-auto">
                                     ...
                                     <picture>
                                         <source srcset="<?= getMediaPath('events_carousel_32') ?>" data-media-key="events_carousel_32" media="(min-width: 1024px)"
                                             type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_32') ?>" data-media-key="events_carousel_32" media="(min-width: 768px)"
                                             type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_32') ?>" data-media-key="events_carousel_32" type="image/webp">
                                         <source srcset="<?= getMediaPath('events_carousel_32') ?>" data-media-key="events_carousel_32" media="(min-width: 1024px)">
                                         <source srcset="<?= getMediaPath('events_carousel_32') ?>" data-media-key="events_carousel_32" media="(min-width: 768px)">
                                         <img src="<?= getMediaPath('events_carousel_32') ?>" data-media-key="events_carousel_32" class="w-full h-full object-cover  "
                                             alt="Sporting achievements at midas touch" width="400" height=""
                                             loading="lazy">
                                     </picture>
                                 </div>
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-8 items-center">
                             ...
                             <div class="hidden md:flex carousel-pagination md:justify-center" data-swiper-pagination>
                             </div>
                                 ...
                                 <div class="flex gap-4 items-center">
                                     <button role="button"
                                         ...
                                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 37 33">
                                             <path id="hulmjsydvx-Vector" fill="currentColor"
                                             ...
                                             <path id="hulmjsydvx-Vector_2" fill="currentColor"
                                     ...
                                     <button role="button"
                                         ...
                                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 37 33">
                                             <path id="hcsaexdcad-Vector" fill="currentColor"
                                                 d="M4.31 17.957c9.063-.069 18.093-.182 27.157-.25 1.957.004 1.715-2.739-.208-2.698-9.064.068-18.094.182-27.157.25-1.957-.005-1.75 2.693.207 2.698Z">
                                             </path>
                                             <path id="hcsaexdcad-Vector_2" fill="currentColor"
                                                 d="M20.052 28.432c5.305-4.215 10.524-8.435 15.829-12.65.714-.577.644-1.694-.228-2.162-4.319-2.377-9.443-8.782-14.138-10.487-1.802-.67-2.71 1.97-.904 2.564 4.488 1.579 9.317 7.93 13.469 10.221-.09-.734-.14-1.428-.229-2.162-5.305 4.215-10.524 8.434-15.829 12.65-1.427 1.153.603 3.18 2.03 2.026Z">
                                             </path>
                                         </svg>
                 ...
                 <a name="after-school-clubs"></a>

                 <section data-block="text" class="relative bg-white pt-16 lg:pt-32 mb-16 lg:mb-32 ">
                     <div class="container-sm space-y-12">
                         <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                             <h2 class="h2 text-line grow-0">after-school clubs</h2>
                         </div>
                         <div class="prose">
                             <p class="text-base">Below is a list of some of the after-school clubs we run and we
                                 welcome new ideas and interests expressed by pupils and parents.<br /><br /></p>
                             <h3>Pre-Prep</h3>
                             <table>
                                 <tbody>
                                     <tr>
                                         <td>
                                             <p>Art and Craft Activities</p>
                                         </td>
                                         <td>
                                             <p>Athletics</p>
                                         </td>
                             ...
                             <table>
                                 <tbody>
                                     ...
                                     <tr>
                                         <td>
                                             <p></p>
                                             <p>Mindfulness, Sensory and Yoga</p>
                                             <p></p>
                                         </td>
                                         <td>
                                             <p>Sailing</p>
