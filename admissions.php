 ...
 <body class="font-body text-base font-light lg:text-md text-secondary antialiased">
     ...
     <main class="" id="content">
         <section data-block="hero" class="h-screen" data-sal="fade">
             ...
             <picture>
                 <source srcset="<?= getMediaPath('admissions_hero_7') ?>" data-media-key="admissions_hero_7" data-media-key="admissions_hero_7" media="(min-width: 1024px)" type="image/webp">
                 <source srcset="<?= getMediaPath('admissions_hero_7') ?>" data-media-key="admissions_hero_7" data-media-key="admissions_hero_7" media="(min-width: 768px)" type="image/webp">
                 <source srcset="<?= getMediaPath('admissions_hero_7') ?>" data-media-key="admissions_hero_7" data-media-key="admissions_hero_7" type="image/webp">
                 <source srcset="<?= getMediaPath('admissions_hero_7') ?>" data-media-key="admissions_hero_7" data-media-key="admissions_hero_7" media="(min-width: 1024px)">
                 <source srcset="<?= getMediaPath('admissions_hero_7') ?>" data-media-key="admissions_hero_7" data-media-key="admissions_hero_7" media="(min-width: 768px)">
                 <img src="<?= getMediaPath('admissions_hero_7') ?>" data-media-key="admissions_hero_7" data-media-key="admissions_hero_7" class="w-full h-full object-cover " alt="Middles2" width="562"
         ...
         <article id="pageContent" class="relative animate-slide-up -top-[var(--travel)] -mb-[var(--travel)]"
             ...
             <div class="bg-white pt-8 lg:pt-0">
                 <div class="container-sm relative mb-12 md:mb-16 lg:-top-12 2xl:-top-24 lg:mb-8 2xl:mb-0 animate-fade-in"
                     ...
                     <h1 class="h1 text-primary text-balance">Admissions</h1>
                     <h2 class="h3 text-primary mt-4">We’re here to support you, every step of the way</h2>
                     <div class="prose mt-12">
                         <p><strong>At MidasTouch, we want to foster a love of learning and curiosity. We want our
                                 children to have a thirst for discovery as well as a sense of adventure and creativity.
                                 Most importantly though, we want all our pupils to have fun!</strong><br />
                             <strong><br /></strong>When it comes to admissions, we recommend you to Fix a Meeting with
                             our admission team for a discussion about your child’s interests and goals.
                             We are commited to making this process smooth and transparent. Our team is available to
                     ...
                     <div class="container grid grid-cols-1 gap-8 lg:gap-x-0 items-center md:grid-cols-2">
                         <div class="relative order-2  pt-12 mb:pb-12 md:mb-24  ">
                             <div class="relative lg:max-w-sm lg:mx-auto gs-animate" data-anim-x="150">
                                 ...
                                 <h3 class="h2 text-line">Don’t just take our word for it</h3>

                                 <div class="mt-4 prose text-base font-normal">
                                     <p>Our MidasTouch families are our biggest advocates so we’re going to let them do
                                         the talking.</p>
                                 </div>

                                 <div class="mt-8 flex flex-wrap lg:flex-nowrap items-center gap-4">
                                     <a href="<?= getVideoLink('admissions_testimonial_youtube') ?>"
                                         class="inline-block flex-shrink-0 flex-grow-0" target="_blank" rel="noopener"
                                         aria-label="opens new tab" x-data="{}" @click.prevent="$dispatch('open-lightbox', `  <iframe 
        src='<?= getVideoLink("admissions_testimonial_youtube", "embed") ?>&autoplay=1' 
        ...
        allowfullscreen>
                                     ...
                                     <a class="c-button" href="faqs.php">More videos</a>
                                 </div>
                             ...
                             <figure
                                 ...
                                 <img src="<?= getMediaPath('admissions_svg_hand') ?>" data-media-key="admissions_svg_hand" data-media-key="admissions_svg_hand" class="w-full h-full object-contain object-left-bottom "
                                     alt="GWS hockey girl" style="width:100px;height:auto;" loading="lazy">
                             </figure>
                         </div>
                             ...
                             <div class="w-[110%] md:w-[125%] -translate-x-[5%] md:-translate-x-1/4">
                                 ...
                                 <div class="-rotate-6  u-mask-border">
                                     <div class="relative u-mask-image" x-data="{playing: true}">
                                         ...
                                         <?= renderMedia('admissions_video_c1357', 'w-full h-full object-cover aspect-video relative js-video-scroll', ['autoplay' => true, 'muted' => true, 'loop' => true, 'playsinline' => true, 'x-ref' => 'video']) ?>
                                         <button
    ...
    `)">
                 ...
                 <section data-block="accordion" class="container-sm space-y-12 my-16 lg:my-32">
                     <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                         <h2 class="h2 text-line grow-0">Admissions process</h2>
                         <div class="prose text-base font-normal max-w-2xl mx-auto">
                             <p>Our admissions process is simple:</p>
                         </div>
                     </div>
                     <div>
                         <article class="relative border-b border-grey-dark border-t" x-data="{expanded: false}"
                             data-sal="fade" data-sal-delay="0" data-sal-duration="400">
                             <button role="button"
                                 class="relative appearance-none w-full p-4 md:px-8 md:py-8 flex items-center justify-between hover:text-white cursor-pointer text-left group "
                                 @click="expanded = !expanded" title="Open accordion for Come and meet us">
                                 <span
                                     class="absolute inset-x-0 -inset-y-1 bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 u-mask-bg"></span>
                                 <h3 class="relative h4 flex-1">Come and meet us</h3>
                                 <i class="relative w-7 block text-primary group-hover:text-white" role="presentation"
                                     :class="{'-rotate-180': expanded}">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 16">
                                         <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                             stroke-width="4"
                                             d="M2 2.5c1.429.792 10.257 10.323 11.566 11.5 1.19-.951 2.529-1.933 3.444-2.901l2.575-2.723A25.022 25.022 0 0 1 21.78 6.31c.883-.781 2.461-2.98 3.72-4.31" />
                                     </svg>
                                 </i>
                             </button>
                             <div x-show="expanded" class="p-5 flex flex-wrap items-center gap-8 md:flex-row-reverse">
                                 <div class="w-full md:flex-1 space-y-4">
                                     <div class="prose text-base font-normal">
                                         <p>Come and meet with our Admission team, have a tour of the school and see
                                             what makes us tick.</p>
                                     </div>
                                     <a class="c-button-text" href="book-a-visit.php">Book a Visit</a>
                                 </div>
                             </div>
                         </article>
                         <article class="relative border-b border-grey-dark " x-data="{expanded: false}" data-sal="fade"
                             data-sal-delay="200" data-sal-duration="400">
                             <button role="button"
                                 class="relative appearance-none w-full p-4 md:px-8 md:py-8 flex items-center justify-between hover:text-white cursor-pointer text-left group "
                                 @click="expanded = !expanded" title="Open accordion for Register">
                                 <span
                                     class="absolute inset-x-0 -inset-y-1 bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 u-mask-bg"></span>
                                 <h3 class="relative h4 flex-1">Register</h3>
                                 <i class="relative w-7 block text-primary group-hover:text-white" role="presentation"
                                     :class="{'-rotate-180': expanded}">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 16">
                                         <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                             ...
                             <div x-show="expanded" class="p-5 flex flex-wrap items-center gap-8 md:flex-row-reverse">
                                 <div class="w-full md:flex-1 space-y-4">
                                     <div class="prose text-base font-normal">
                                         <p>If you decide this is the school for you then you can register your child by
                                             completing our online form - shared with you directly by our admissions
                                             team.</p>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <article class="relative border-b border-grey-dark " x-data="{expanded: false}" data-sal="fade"
                             data-sal-delay="600" data-sal-duration="400">
                             <button role="button"
                                 class="relative appearance-none w-full p-4 md:px-8 md:py-8 flex items-center justify-between hover:text-white cursor-pointer text-left group "
                                 @click="expanded = !expanded" title="Open accordion for Offer letter">
                                 <span
                                     class="absolute inset-x-0 -inset-y-1 bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 u-mask-bg"></span>
                                 <h3 class="relative h4 flex-1">Offer letter</h3>
                                 <i class="relative w-7 block text-primary group-hover:text-white" role="presentation"
                                     :class="{'-rotate-180': expanded}">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 16">
                                         <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                             ...
                             <div x-show="expanded" class="p-5 flex flex-wrap items-center gap-8 md:flex-row-reverse">
                                 <div class="w-full md:flex-1 space-y-4">
                                     <div class="prose text-base font-normal">
                                         <p>Once we’ve made sure that we’re a perfect match, we will send out an offer
                                             letter.</p>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <article class="relative border-b border-grey-dark " x-data="{expanded: false}" data-sal="fade"
                             data-sal-delay="800" data-sal-duration="400">
                             <button role="button"
                                 class="relative appearance-none w-full p-4 md:px-8 md:py-8 flex items-center justify-between hover:text-white cursor-pointer text-left group "
                                 @click="expanded = !expanded" title="Open accordion for Accept the offer">
                                 <span
                                     class="absolute inset-x-0 -inset-y-1 bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 u-mask-bg"></span>
                                 <h3 class="relative h4 flex-1">Accept the offer</h3>
                                 <i class="relative w-7 block text-primary group-hover:text-white" role="presentation"
                                     :class="{'-rotate-180': expanded}">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 16">
                                         <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                             ...
                             <div x-show="expanded" class="p-5 flex flex-wrap items-center gap-8 md:flex-row-reverse">
                                 <div class="w-full md:flex-1 space-y-4">
                                     <div class="prose text-base font-normal">
                                         <p>Follow the instructions in your offer letter, or contact us here</p>
                                     </div>
                                     <a class="c-button-text" href="contact-us.php">Contact Us</a>
                                 </div>
                             </div>
                         </article>
                         <article class="relative border-b border-grey-dark " x-data="{expanded: false}" data-sal="fade"
                             data-sal-delay="1000" data-sal-duration="400">
                             <button role="button"
                                 class="relative appearance-none w-full p-4 md:px-8 md:py-8 flex items-center justify-between hover:text-white cursor-pointer text-left group "
                                 @click="expanded = !expanded" title="Open accordion for Complete the paperwork">
                                 <span
                                     class="absolute inset-x-0 -inset-y-1 bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 u-mask-bg"></span>
                                 <h3 class="relative h4 flex-1">Complete the paperwork</h3>
                                 <i class="relative w-7 block text-primary group-hover:text-white" role="presentation"
                                     :class="{'-rotate-180': expanded}">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 16">
                                         <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                             ...
                             <div x-show="expanded" class="p-5 flex flex-wrap items-center gap-8 md:flex-row-reverse">
                                 <div class="w-full md:flex-1 space-y-4">
                                     <div class="prose text-base font-normal">
                                         <p>Once the offer is accepted, our admissions team will liaise with you to
                                             complete all the relevant paperwork.</p>
                                     </div>
                                 </div>
                             </div>
                         </article>
                 ...
                 <section data-block="text" class="relative bg-white pt-16 lg:pt-32 mb-16 lg:mb-32 ">
                     <div class="container-sm space-y-12">
                         <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                             <h2 class="h2 text-line grow-0">Joining our MidasTouch Family</h2>
                         </div>
                         <div class="prose">
                             <p></p>
                             <p>When starting a new school the most important thing is that your child feels happy and
                                 settled. To help with this transition we provide each new pupil with a buddy or two in
                                 their class who shares similar interests.</p>
                             <p></p>
                             <figure
                                 style="float:right;width:433px;max-width:433px;margin-left:10px;margin-right:10px;">
                                 <img src="<?= getMediaPath('admissions_leaf_image') ?>" data-media-key="admissions_leaf_image" data-media-key="admissions_leaf_image" width="433" height="328"
                                     alt="" /></figure>
                             <p>Our teachers take time to help each new pupil to feel settled but also to help new
                                 parents to understand the routines and systems.</p>
                             <p>The link between school and home is incredibly important and we work hard on developing
                                 that. we provide a friendly environment where parents can keep in touch or ask any
                                 questions in a friendly, relaxed setting.</p>
                         </div>
                     </div>
                     ...
                     <div class="container grid grid-cols-1 gap-8 lg:gap-x-0 items-center md:grid-cols-2">
                         <div class="relative order-2  pt-12 mb:pb-12 md:mb-24  ">
                             <div class="relative lg:max-w-sm lg:mx-auto gs-animate" data-anim-x="150">
                                 ...
                                 <div class="mt-4 prose text-base font-normal">
                                     <p> You might find the answer in our FAQ section or from one of our testimonial
                                         videos.</p>
                                 </div>
                                 <div class="mt-8 flex flex-wrap lg:flex-nowrap items-center gap-4">
                                     <a class="c-button" href="faqs.php">Take me to the FAQs</a>
                                 </div>
                             </div>
                             <figure
                                 class="hidden md:block absolute right-0 bottom-0 md:translate-y-full lg:translate-y-3/4 md:translate-x-1/2 w-28 xl:w-auto"
                                 ...
                                 <img src="<?= getMediaPath('admissions_svg_lotus') ?>" data-media-key="admissions_svg_lotus" data-media-key="admissions_svg_lotus"
                                     class="w-full h-full object-contain object-left-bottom " alt="GWS trumpet boy"
                             ...
                             <div class="w-[110%] md:w-[125%] -translate-x-[5%] md:-translate-x-1/4">
                                 ...
                                 <div class="-rotate-6  u-mask-border">
                                     <div class="relative u-mask-image" x-data="{playing: true}">
                                         <span
                                             class="absolute inset-0 flex items-center justify-center h2-sm">Loading...</span>
                                         <video x-ref="video" data-src="<?= getMediaPath('home_video_6') ?>" data-media-key="home_video_6" data-media-key="home_video_6" muted
