 ...
 <body class="font-body text-base font-light lg:text-md text-secondary antialiased">
     ...
     <main class="" id="content">
         <section data-block="hero" class="h-screen" data-sal="fade">
             ...
             <picture>
                 <source srcset="<?= getMediaPath('gallery_hero_19') ?>" data-media-key="gallery_hero_19" media="(min-width: 1024px)" type="image/webp">
                 <source srcset="<?= getMediaPath('gallery_hero_19') ?>" data-media-key="gallery_hero_19" media="(min-width: 768px)" type="image/webp">
                 <source srcset="<?= getMediaPath('gallery_hero_19') ?>" data-media-key="gallery_hero_19" type="image/webp">
                 <source srcset="<?= getMediaPath('gallery_hero_19') ?>" data-media-key="gallery_hero_19" media="(min-width: 1024px)">
                 <source srcset="<?= getMediaPath('gallery_hero_19') ?>" data-media-key="gallery_hero_19" media="(min-width: 768px)">
                 <img src="<?= getMediaPath('gallery_hero_19') ?>" data-media-key="gallery_hero_19" class="w-full h-full object-cover " alt="Middles2" width="562"
         ...
         <article id="pageContent" class="relative animate-slide-up -top-[var(--travel)] -mb-[var(--travel)]"
             ...
             <div class="bg-white pt-8 lg:pt-0">
                 <div class="container-sm relative mb-12 md:mb-16 lg:-top-12 2xl:-top-24 lg:mb-8 2xl:mb-0 animate-fade-in"
                     ...
                     <h1 class="h1 text-primary text-balance">Video Gallery</h1>
                     <div class="prose mt-12">
                         <p dir="ltr" class="lead">If you would like to get a better sense of Midas touch, this is a
                             great place to start! Sit back and enjoy.</p>
                         <p><br /></p>
                     </div>
                 </div>
                         ...
                         <div class="relative order-2 pt-12 md:pt-0   md:order-first">
                             <div class="relative lg:max-w-sm lg:mx-auto gs-animate" data-anim-x="-150">
                                 ...
                                 <div class="mt-4 prose text-base font-normal">
                                     <p>Come on a secret mission to discover the sparks of magic that make Midas Touch
                                         so unique.</p>
                                 </div>
    ...
    `)">
                             ...
                             <div class="w-[110%] md:w-[125%] -translate-x-[5%] md:translate-x-0">
                                 ...
                                 <div class="rotate-6  u-mask-border">
                                     <div class="relative u-mask-image" x-data="{playing: true}">
                                         ...
                                         <video x-ref="video" data-src="<?= getMediaPath('gallery_video_3') ?>" data-media-key="gallery_video_3" muted
                                     ...
                                     <a href="https://youtu.be/MkHPN6xJ_zg?si=St7TtwNQSrCnOkTO"
     ...
     <iframe 
       src='https://www.youtube.com/embed/MkHPN6xJ_zg?si=St7TtwNQSrCnOkTO&amp;autoplay=1' 
   ...
   `)">
                     ...
                     <div class="container grid grid-cols-1 gap-8 lg:gap-x-0 items-center md:grid-cols-2">
                         <div class="relative order-2  pt-12 mb:pb-12 md:mb-24  ">
                             <div class="relative lg:max-w-sm lg:mx-auto gs-animate" data-anim-x="150">
                                 ...
                                 <div class="mt-4 prose text-base font-normal">
                                     <p>Find out what Mud π is all about. From erosion in action on the edge of a stream
                                         to peaceful poetry under a tree we maximise our environment, bringing lessons
                                         to life.</p>
                                 </div>
                                 <div class="mt-8 flex flex-wrap lg:flex-nowrap items-center gap-4">
                                     <a href="https://youtu.be/IG7NbpsWaFQ?si=OBEBZErjo4tcL31A"
    ...
    `)">
                             ...
                             <figure
                                 ...
                                 <img src="<?= getMediaPath('gallery_gif_1') ?>" data-media-key="gallery_gif_1"
                             ...
                             <div class="w-[110%] md:w-[125%] -translate-x-[5%] md:-translate-x-1/4">
                                 ...
                                 <div class="-rotate-6  u-mask-border">
                                     <div class="relative u-mask-image" x-data="{playing: true}">
                                         <span
                                             class="absolute inset-0 flex items-center justify-center h2-sm">Loading...</span>
                                         <video x-ref="video" data-src="<?= getMediaPath('gallery_video_6') ?>" data-media-key="gallery_video_6" muted
                                             loop role="presentation"
                                             class="w-full h-full object-cover aspect-video relative js-video-scroll"></video>
                                         <button
                             ...
                             <div class="relative lg:max-w-sm lg:mx-auto gs-animate" data-anim-x="-150">
                                 ...
                                 <div class="mt-4 prose text-base font-normal">
                                     <p>Building dens, experimenting in science labs, and discovering passions are all
                                         part of the Year 7 &amp; 8 experience at Midas Touch.</p>
                                     <p>Through our unique Mud Pi philosophy, we celebrate childhood with adventure,
                                         exploration, and outdoor play, helping children build confidence and embrace
                                         new challenges.</p>
                                     <p>Watch this video for a glimpse into the Year 7 &amp; 8 journey!</p>
                                 </div>
                                 <div class="mt-8 flex flex-wrap lg:flex-nowrap items-center gap-4">
                                     <a href="https://youtu.be/IG7NbpsWaFQ?si=OBEBZErjo4tcL31A"
                                         class="inline-block flex-shrink-0 flex-grow-0" target="_blank" rel="noopener"
                             ...
                             <div class="w-[110%] md:w-[125%] -translate-x-[5%] md:translate-x-0">
                                 ...
                                 <div class="rotate-6  u-mask-border">
                                     <div class="relative u-mask-image" x-data="{playing: true}">
                                         <span
                                             class="absolute inset-0 flex items-center justify-center h2-sm">Loading...</span>
                                         <video x-ref="video" data-src="<?= getMediaPath('gallery_video_5') ?>" data-media-key="gallery_video_5" muted
                                             loop role="presentation"
                                             class="w-full h-full object-cover aspect-video relative js-video-scroll"></video>
                                         <button
                                             class="absolute bottom-4 left-3 w-8 h-8 rounded-full border-2 border-white text-white flex items-center justify-center"
    ...
    `)">
                 ...
                 <section data-block="videoGrid" class="container space-y-12 my-16 lg:my-32">
                     <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                         <h2 class="h2 text-line grow-0">Hear from our Midas Touch families</h2>
                     ...
                     <div class="grid gap-6 md:grid-cols-2 ">
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('gallery_testimonial_6') ?>" data-media-key="gallery_testimonial_6" media="(min-width: 1024px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_6') ?>" data-media-key="gallery_testimonial_6" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_6') ?>" data-media-key="gallery_testimonial_6" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_6') ?>" data-media-key="gallery_testimonial_6" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_6') ?>" data-media-key="gallery_testimonial_6" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('gallery_testimonial_6') ?>" data-media-key="gallery_testimonial_6" class="w-full u-mask-image "
   ...
   `)">
                         ...
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('gallery_testimonial_5') ?>" data-media-key="gallery_testimonial_5" media="(min-width: 1024px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_5') ?>" data-media-key="gallery_testimonial_5" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_5') ?>" data-media-key="gallery_testimonial_5" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_5') ?>" data-media-key="gallery_testimonial_5" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('gallery_testimonial_5') ?>" data-media-key="gallery_testimonial_5" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('gallery_testimonial_5') ?>" data-media-key="gallery_testimonial_5" class="w-full u-mask-image "
   ...
   `)">
                     ...
                     <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('gallery_faq_36') ?>" data-media-key="gallery_faq_36" media="(min-width: 1024px)"
                                         type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_36') ?>" data-media-key="gallery_faq_36" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_36') ?>" data-media-key="gallery_faq_36" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_36') ?>" data-media-key="gallery_faq_36" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('gallery_faq_36') ?>" data-media-key="gallery_faq_36" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('gallery_faq_36') ?>" data-media-key="gallery_faq_36" class="w-full u-mask-image " alt="FAQs Emma"
    ...
    `)">
                         ...
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('gallery_faq_37') ?>" data-media-key="gallery_faq_37" media="(min-width: 1024px)"
                                         type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_37') ?>" data-media-key="gallery_faq_37" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_37') ?>" data-media-key="gallery_faq_37" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_37') ?>" data-media-key="gallery_faq_37" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('gallery_faq_37') ?>" data-media-key="gallery_faq_37" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('gallery_faq_37') ?>" data-media-key="gallery_faq_37" class="w-full u-mask-image " alt="FAQs Emma"
                                         width="410" height="225" loading="lazy">
                                 </picture>
                                 <a href="" role="button" class="absolute inset-0 grid place-content-center" x-data="{}"
                                     @click.prevent="$dispatch('open-lightbox', `
    ...
    `)">
                         ...
                         <article class="space-y-4">
                             <div class="relative">
                                 ...
                                 <picture>
                                     <source srcset="<?= getMediaPath('gallery_faq_38') ?>" data-media-key="gallery_faq_38" media="(min-width: 1024px)"
                                         type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_38') ?>" data-media-key="gallery_faq_38" media="(min-width: 768px)" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_38') ?>" data-media-key="gallery_faq_38" type="image/webp">
                                     <source srcset="<?= getMediaPath('gallery_faq_38') ?>" data-media-key="gallery_faq_38" media="(min-width: 1024px)">
                                     <source srcset="<?= getMediaPath('gallery_faq_38') ?>" data-media-key="gallery_faq_38" media="(min-width: 768px)">
                                     <img src="<?= getMediaPath('gallery_faq_38') ?>" data-media-key="gallery_faq_38" class="w-full u-mask-image " alt="FAQs Emma"
                                         width="410" height="225" loading="lazy">
                                 </picture>
                                 <a href="" role="button" class="absolute inset-0 grid place-content-center" x-data="{}"
                                     @click.prevent="$dispatch('open-lightbox', `
    ...
    `)">
                             ...
                             <h3 class="h2-sm text-center">Can you tell me a little bit more about Midas Touch ?</h3>
                         </article>
                         <article class="space-y-4">
                             <div class="relative">
    ...
    `)">
                             ...
                             <h3 class="h2-sm text-center">What sports do Midas Touch play?</h3>
                         </article>
                         <article class="space-y-4" x-show="showMore">
                             <div class="relative">
    ...
    `)">
                             ...
                             <h3 class="h2-sm text-center">Do you feel Midas Touch have prepared you for senior school?
                             </h3>
                         </article>
                         <article class="space-y-4" x-show="showMore">
                             <div class="relative">
    ...
    `)">
                             ...
                             <h3 class="h2-sm text-center">What&#039;s the advantage of the Y7&amp;8 experience at Midas
                                 Touch?</h3>
                         </article>
                         <article class="space-y-4" x-show="showMore">
                             <div class="relative">
    ...
    `)">
                 ...
                 <section data-block="videoGrid" class="container space-y-12 my-16 lg:my-32">
                     <div class="gap-y-4 text-center flex flex-col w-full items-center ">
                         <h2 class="h2 text-line grow-0">More from Midas Touch</h2>
                     </div>
                     <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                         <article class="space-y-4">
                             <div class="relative">
