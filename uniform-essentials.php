...
<?php require_once("includes/media-helper.php"); ?>
  ...
  <picture>
          <source
        srcset=
          "<?= getMediaPath('uniform_hero_26') ?>" data-media-key="uniform_hero_26"
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M1.5 12c.52-.37 1.035-.824 1.56-1.357a6.367 6.367 0 0 1 1.6-.836 6.19 6.19 0 0 0 1.546-.785c.45-.32.837-.658 1.158-1.01.313-.357.682-.76 1.136-1.083-.334-.315-.676-.67-1.02-.914l-.966-.69a7.973 7.973 0 0 1-.73-.584 16.705 16.705 0 0 0-1.117-.861C3.38 2.961 2.41 2.333 1.762 2"></path>
                  ...
                  <li>
      <span class="">MidasTouch School Uniform</span>
    </li>
  </ul>
</nav>
        <h1 class="h1 text-primary text-balance">MidasTouch School Uniform</h1>
                          <div class="prose mt-12">
						  <p>The school uniform reflects our values of discipline and unity. All students are required to wear the prescribed uniform on all working days. Uniforms help build a sense of identity and belonging among students.</p>
						  <p>Proper grooming and hygiene are essential to our school culture. Students must wear neatly pressed uniforms, polished shoes, and appropriate accessories. Fancy hairstyles, ornaments, and makeup are not allowed to maintain uniformity and focus.</p>
						  <p>Uniform regulations apply during field trips, PTMs, special classes, and school functions. Girls must wear cycling shorts under skirts and boys must wear underpants. All students must carry their identity cards daily for security and identification.</p>
						  </div>
              </div>
...
data-loop="true"data-space="32">
  ...
  <picture>
          <source
        srcset=
          "<?= getMediaPath('uniform_gallery_27') ?>" data-media-key="uniform_gallery_27"
        media="(min-width: 1024px)"
        type="image/webp">
      <source
        srcset=
...
class="bg-white my-16 lg:my-32 ">
  <div class="container space-y-24">
    <div class="gap-y-4 text-center flex flex-col w-full items-center ">
            <h2 class="h2 text-line grow-0">Uniform Guidelines</h2>
        </div>
  ...
  <div class="relative flex-1">
    <ul>
            <li>Neatness & Cleanliness: Uniforms must be clean, well-maintained, and properly worn at all times. Shoes should be regularly polished and socks must have good elasticity.</li>
          </ul>
      </div>
...
class="relative bg-white pt-16 lg:pt-32 mb-16 lg:mb-32 ">
  <div class="container-sm space-y-12">
    <div class="gap-y-4 text-center flex flex-col w-full items-center ">
            <h2 class="h2 text-line grow-0">School Uniform</h2>
        </div>
    <div class="prose">
      <p>If you would like to make an appointment for uniform or have an enquiry relating to uniform please click the link below<br /></p>
    </div>
        <a class="c-button-text" href="mailto: midastouchse@gmail.com">Uniform Email</a>
      </div>
