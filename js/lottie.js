(() => {
			...
			234: function(t, e, i) {
				"undefined" != typeof navigator && (t.exports = function() {
					...
					var y = !0,
						...
						b = null,
						_ = "",
						k = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
						P = Math.pow,
						A = Math.sqrt,
						S = Math.floor,
						x = (Math.max, Math.min),
					...
					var O, N = (O = 0, function() {
						return _ + "__lottie_element_" + (O += 1)
					});
					...
					function j(t, e) {
						var i = q(255 * t[0], 255 * t[1], 255 * t[2]);
						return i[1] += e, i[1] > 1 ? i[1] = 1 : i[1] <= 0 && (i[1] = 0), B(i[0], i[1], i[2])
					}

					function W(t, e) {
						var i = q(255 * t[0], 255 * t[1], 255 * t[2]);
						return i[2] += e, i[2] > 1 ? i[2] = 1 : i[2] < 0 && (i[2] = 0), B(i[0], i[1], i[2])
					}

					function X(t, e) {
						var i = q(255 * t[0], 255 * t[1], 255 * t[2]);
						return i[0] += e / 360, i[0] > 1 ? i[0] -= 1 : i[0] < 0 && (i[0] += 1), B(i[0], i[1], i[2])
					}! function() {
						var t, e, i = [];
									...
									function e() {
													...
													if (n.completed = !0, n.hasMask) {
														...
														for (l = m.length, h = 0; h < l; h += 1)
															if (m[h].pt.k.i) r(m[h].pt.k);
																...
																for (f = m[h].pt.k.length, p = 0; p < f; p += 1) m[h].pt.k[p].s && r(m[h].pt.k[p].s[0]), m[h].pt.k[p].e && r(m[h].pt.k[p].e[0])
													}
													0 === n.ty ? (n.layers = s(n.refId, i), t(n.layers, i)) : 4 === n.ty ? a(n.shapes) : 5 === n.ty && c(n)
												}
										}
										...
										function e(e, i) {
											if (e) {
												var a = 0,
													r = e.length;
												for (a = 0; a < r; a += 1) 1 === e[a].t && (e[a].data.layers = s(e[a].data.refId, i), t(e[a].data.layers, i))
											}
										}
											...
											for (e = t.length - 1; e >= 0; e -= 1)
												if ("sh" === t[e].ty)
													if (t[e].ks.k.i) r(t[e].ks.k);
														...
														for (s = t[e].ks.k.length, i = 0; i < s; i += 1) t[e].ks.k[i].s && r(t[e].ks.k[i].s[0]), t[e].ks.k[i].e && r(t[e].ks.k[i].e[0]);
										...
										var o, h = function() {
											...
											l = (o = [4, 7, 99], function(t) {
												if (t.chars && !n(o, t.v)) {
													...
													for (e = 0; e < i; e += 1) {
														var s = t.chars[e];
														s.data && s.data.shapes && (a(s.data.shapes), s.data.ip = 0, s.data.op = 99999, s.data.st = 0, s.data.sr = 1, s.data.ks = {
															p: {
																k: [0, 0],
																a: 0
															},
										...
										function m(i) {
											i.__complete || (f(i), h(i), l(i), p(i), d(i), t(i.layers, i.assets), e(i.chars, i.assets), i.__complete = !0)
										}
										...
										var u = {};
										return u.completeData = m, u.checkColors = f, u.checkChars = l, u.checkPathProperties = p, u.checkShapes = d, u.completeLayers = t, u
									}
									if (r.dataManager || (r.dataManager = e()), r.assetLoader || (r.assetLoader = function() {
											function t(t) {
										...
										r.dataManager.completeData(i), r.postMessage({
											id: t.data.id,
											payload: i,
											status: "success"
										})
						...
						it = function() {
							...
							function r(e) {
								var i = s(e, this.assetsPath, this.path),
									a = $("image");
								k ? this.testImageLoaded(a) : a.addEventListener("load", this._imageLoaded, !1), a.addEventListener("error", function() {
					...
					var ft = function() {
						this._cbs = [], this.name = "", this.path = "", this.isLoaded = !1, this.currentFrame = 0, this.currentRawFrame = 0, this.firstFrame = 0, this.totalFrames = 0, this.frameRate = 0, this.frameMult = 0, this.playSpeed = 1, this.playDirection = 1, this.playCount = 0, this.animationData = {}, this.assets = [], this.isPaused = !0, this.autoplay = !1, this.loop = !0, this.renderer = null, this.animationID = N(), this.assetsPath = "", this.timeCompleted = 0, this.segmentPos = 0, this.isSubframeEnabled = Y(), this.segments = [], this._idle = !0, this._completedLoop = !1, this.projectInterface = rt(), this.imagePreloader = new it, this.audioController = m(), this.markers = [], this.configAnimation = this.configAnimation.bind(this), this.onSetupError = this.onSetupError.bind(this), this.onSegmentComplete = this.onSegmentComplete.bind(this), this.drawnFrameEvent = new F("drawnFrame", 0, 0, 0), this.expressionsPlugin = J()
					};
					f([st], ft), ft.prototype.setParams = function(t) {
					...
					}, ft.prototype.onSetupError = function() {
						this.trigger("data_failed")
					}, ft.prototype.setupAnimation = function(t) {
						et.completeAnimation(t, this.configAnimation)
					}, ft.prototype.setData = function(t, e) {
						e && "object" !== pt(e) && (e = JSON.parse(e));
						var i = {
								wrapper: t,
								animationData: e
							},
					...
					}, ft.prototype.onSegmentComplete = function(t) {
					...
					}, ft.prototype.resize = function(t, e) {
						...
						if (e && (this.segments.length = 0), "object" === pt(t[0])) {
							var i, s = t.length;
					...
					}, ft.prototype.setLoop = function(t) {
						this.loop = t
					...
					}, ft.prototype.updateDocumentData = function(t, e, i) {
						try {
						...
						if (this._cbs && this._cbs[t]) switch (t) {
							case "enterFrame":
								this.triggerEvent(t, new F(t, this.currentFrame, this.totalFrames, this.frameModifier));
								break;
							case "drawnFrame":
						...
						var e = new z(t, this.currentFrame);
						this.triggerEvent("error", e), this.onError && this.onError.call(this, e)
					};
					var dt = function() {
							var t = {},
							...
							function o(t) {
								for (var i = 0, a = t.target; i < s;) e[i].animation === a && (e.splice(i, 1), i -= 1, s -= 1, a.isPaused || d()), i += 1
							}
							...
							function m(t, i) {
								t.addEventListener("destroy", o), t.addEventListener("_active", f), t.addEventListener("_idle", d), e.push({
									elem: i,
									animation: t
								}), s += 1
							}
							...
							function v(t) {
								...
								i = t, a && !n ? window.requestAnimationFrame(v) : r = !0
							}

							function b(t) {
								i = t, window.requestAnimationFrame(v)
							}
							...
							function x(t, e, i) {
								var s, a = [].concat([].slice.call(document.getElementsByClassName("lottie")), [].slice.call(document.getElementsByClassName("bodymovin"))),
									r = a.length;
								for (s = 0; s < r; s += 1) i && a[s].setAttribute("data-bm-type", i), h(a[s], t);
								if (e && 0 === r) {
									i || (i = "svg");
							...
							function D() {
								!n && a && r && (window.requestAnimationFrame(b), r = !1)
							}
							...
							return t.registerAnimation = h, t.loadAnimation = c, t.setSpeed = u, t.setDirection = g, t.play = y, t.pause = _, t.stop = P, t.togglePause = A, t.searchAnimations = x, t.resize = w, t.goToAndStop = k, t.destroy = S, t.freeze = M, t.unfreeze = C, t.setVolume = T, t.mute = F, t.unmute = E, t.getRegisteredAnimations = l, t
						}(),
						mt = function() {
							var t = {};
							t.getBezierEasing = i;
						...
						ut = function(t, e, i) {
							...
							function o(t) {
								s === a && (r = ct.double(r), a *= 2), i && i(t), r[s] = t, s += 1
							}
							return {
								newElement: n,
								release: o
					...
					function vt() {
						...
						function i(i, s, a, r, n, o, h, l, p) {
							if (0 === a && 0 === o && 0 === p) return e(i, s, r, n, h, l);
							var f, d = t.sqrt(t.pow(r - i, 2) + t.pow(n - s, 2) + t.pow(o - a, 2)),
						...
						var s = function(t, e, i, s) {
							...
							for (n = i.length, a = 0; a < p; a += 1) {
								for (h = a / (p - 1), l = 0, r = 0; r < n; r += 1) o = P(1 - h, 3) * t[r] + 3 * P(1 - h, 2) * h * i[r] + 3 * (1 - h) * P(h, 2) * s[r] + P(h, 3) * e[r], d[r] = o, null !== m[r] && (l += P(d[r] - m[r], 2)), m[r] = d[r];
								l && (f += l = A(l)), c.percents[a] = h, c.lengths[a] = f
							}
							return c.addedLength = f, c
						};

						function a(t) {
							var e, i = yt.newElement(),
								a = t.c,
								r = t.v,
								n = t.o,
								o = t.i,
								...
								l = i.lengths,
								p = 0;
							for (e = 0; e < h - 1; e += 1) l[e] = s(r[e], r[e + 1], n[e], o[e + 1]), p += l[e].addedLength;
							return a && h && (l[e] = s(r[e], r[0], n[e], o[0]), p += l[e].addedLength), i.totalLength = p, i
						}
						...
						var o, h = (o = {}, function(t, i, s, a) {
							var h = (t[0] + "_" + t[1] + "_" + i[0] + "_" + i[1] + "_" + s[0] + "_" + s[1] + "_" + a[0] + "_" + a[1]).replace(/\./g, "p");
							if (!o[h]) {
								var l, p, f, d, m, c, g, y = Z(),
									v = 0,
									b = null;
								...
								for (f = s.length, l = 0; l < y; l += 1) {
									for (g = u(f), m = l / (y - 1), c = 0, p = 0; p < f; p += 1) d = P(1 - m, 3) * t[p] + 3 * P(1 - m, 2) * m * (t[p] + s[p]) + 3 * (1 - m) * P(m, 2) * (i[p] + a[p]) + P(m, 3) * i[p], g[p] = d, null !== b && (c += P(g[p] - b[p], 2));
									v += c = A(c), _.points[l] = new n(c, g), b = g
								}
								_.segmentLength = v, o[h] = _
							}
							return o[h]
						});
						...
						function p(e, i, s, a, r, n) {
							var o = l(r, n),
								h = 1 - o;
							return [t.round(1e3 * (h * h * h * e[0] + (o * h * h + h * o * h + h * h * o) * s[0] + (o * o * h + h * o * o + o * h * o) * a[0] + o * o * o * i[0])) / 1e3, t.round(1e3 * (h * h * h * e[1] + (o * h * h + h * o * h + h * h * o) * s[1] + (o * o * h + h * o * o + o * h * o) * a[1] + o * o * o * i[1])) / 1e3]
						}
						var f = c("float32", 8);

						function d(e, i, s, a, r, n, o) {
							r < 0 ? r = 0 : r > 1 && (r = 1);
							var h, p = l(r, o),
								d = l(n = n > 1 ? 1 : n, o),
								m = e.length,
								...
								T = d * d * u + u * d * d + d * u * d,
								F = d * d * d;
							for (h = 0; h < m; h += 1) f[4 * h] = t.round(1e3 * (g * e[h] + y * s[h] + v * a[h] + b * i[h])) / 1e3, f[4 * h + 1] = t.round(1e3 * (_ * e[h] + k * s[h] + P * a[h] + A * i[h])) / 1e3, f[4 * h + 2] = t.round(1e3 * (S * e[h] + x * s[h] + w * a[h] + D * i[h])) / 1e3, f[4 * h + 3] = t.round(1e3 * (M * e[h] + C * s[h] + T * a[h] + F * i[h])) / 1e3;
							return f
						}
						return {
							getSegmentsLength: a,
					...
					function Pt(t, e) {
						...
						for (var a, r, n, o, h, l, p, f, d, m = e.lastIndex, u = m, g = this.keyframes.length - 1, y = !0; y;) {
						...
						var v, b = r.t - s,
							_ = a.t - s;
						if (a.to) {
							n.bezierData || (n.bezierData = bt.buildBezierData(a.s, r.s || a.e, a.to, a.ti));
							var k = n.bezierData;
							if (t >= b || t < _) {
								var P = t >= b ? k.points.length - 1 : 0;
								for (h = k.points[P].point.length, o = 0; o < h; o += 1) i[o] = k.points[P].point[o]
							} else {
								n.__fnct ? d = n.__fnct : (d = mt.getBezierEasing(a.o.x, a.o.y, a.i.x, a.i.y, a.n).get, n.__fnct = d), l = d((t - _) / (b - _));
								var A, S = k.segmentLength * l,
									x = e.lastFrame < t && e._lastKeyframeIndex === u ? e._lastAddedLength : 0;
								for (f = e.lastFrame < t && e._lastKeyframeIndex === u ? e._lastPoint : 0, y = !0, p = k.points.length; y;) {
									if (x += k.points[f].partialLength, 0 === S || 0 === l || f === k.points.length - 1) {
										for (h = k.points[f].point.length, o = 0; o < h; o += 1) i[o] = k.points[f].point[o];
										break
									}
									if (S >= x && S < x + k.points[f + 1].partialLength) {
										for (A = (S - x) / k.points[f + 1].partialLength, h = k.points[f].point.length, o = 0; o < h; o += 1) i[o] = k.points[f].point[o] + (k.points[f + 1].point[o] - k.points[f].point[o]) * A;
										break
									}
									f < p - 1 ? f += 1 : y = !1
								}
								e._lastPoint = f, e._lastAddedLength = x - k.points[f].partialLength, e._lastKeyframeIndex = u
							}
						} else {
							var w, D, M, C, T;
							if (g = a.s.length, v = r.s || a.e, this.sh && 1 !== a.h) t >= b ? (i[0] = v[0], i[1] = v[1], i[2] = v[2]) : t <= _ ? (i[0] = a.s[0], i[1] = a.s[1], i[2] = a.s[2]) : St(i, At(xt(a.s), xt(v), (t - _) / (b - _)));
							else
								for (u = 0; u < g; u += 1) 1 !== a.h && (t >= b ? l = 1 : t < _ ? l = 0 : (a.o.x.constructor === Array ? (n.__fnct || (n.__fnct = []), n.__fnct[u] ? d = n.__fnct[u] : (w = void 0 === a.o.x[u] ? a.o.x[0] : a.o.x[u], D = void 0 === a.o.y[u] ? a.o.y[0] : a.o.y[u], M = void 0 === a.i.x[u] ? a.i.x[0] : a.i.x[u], C = void 0 === a.i.y[u] ? a.i.y[0] : a.i.y[u], d = mt.getBezierEasing(w, D, M, C).get, n.__fnct[u] = d)) : n.__fnct ? d = n.__fnct : (w = a.o.x, D = a.o.y, M = a.i.x, C = a.i.y, d = mt.getBezierEasing(w, D, M, C).get, a.keyframeMetadata = d), l = d((t - _) / (b - _)))), v = r.s || a.e, T = 1 === a.h ? a.s[u] : a.s[u] + (v[u] - a.s[u]) * l, "multidimensional" === this.propType ? i[u] = T : i = T
						}
					...
					function St(t, e) {
						var i = e[0],
							...
							o = Math.asin(2 * i * s + 2 * a * r),
							h = Math.atan2(2 * i * r - 2 * s * a, 1 - 2 * i * i - 2 * a * a);
						t[0] = n / M, t[1] = o / M, t[2] = h / M
					}
					...
					function Dt(t) {
						var e;
						if ("unidimensional" === this.propType) e = t * this.mult, kt(this.v - e) > 1e-5 && (this.v = e, this._mdf = !0);
						else
							for (var i = 0, s = this.v.length; i < s;) e = t[i] * this.mult, kt(this.v[i] - e) > 1e-5 && (this.v[i] = e, this._mdf = !0), i += 1
					}
					...
					function Tt(t, e, i, s) {
						this.propType = "unidimensional", this.mult = i || 1, this.data = e, this.v = i ? e.k * i : e.k, this.pv = e.k, this._mdf = !1, this.elem = t, this.container = s, this.comp = t.comp, this.k = !1, this.kf = !1, this.vel = 0, this.effectsSequence = [], this._isFirstFrame = !0, this.getValue = Mt, this.setVValue = Dt, this.addEffect = Ct
					}
					...
					function Ft(t, e, i, s) {
						...
						var r = e.k.length;
						for (this.v = c("float32", r), this.pv = c("float32", r), this.vel = c("float32", r), a = 0; a < r; a += 1) this.v[a] = e.k[a] * this.mult, this.pv[a] = e.k[a];
						this._isFirstFrame = !0, this.effectsSequence = [], this.getValue = Mt, this.setVValue = Dt, this.addEffect = Ct
					}
					...
					function Et(t, e, i, s) {
						...
						}, this.k = !0, this.kf = !0, this.data = e, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.v = _t, this.pv = _t, this._isFirstFrame = !0, this.getValue = Mt, this.setVValue = Dt, this.interpolateValue = Pt, this.effectsSequence = [wt.bind(this)], this.addEffect = Ct
					}

					function It(t, e, i, s) {
						var a;
						this.propType = "multidimensional";
						var r, n, o, h, l = e.k.length;
						...
						this.effectsSequence = [wt.bind(this)], this.data = e, this.keyframes = e.k, this.keyframesMetadata = [], this.offsetTime = t.data.st, this.k = !0, this.kf = !0, this._isFirstFrame = !0, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.getValue = Mt, this.setVValue = Dt, this.interpolateValue = Pt, this.frameId = -1;
						var p = e.k[0].s.length;
						for (this.v = c("float32", p), this.pv = c("float32", p), a = 0; a < p; a += 1) this.v[a] = _t, this.pv[a] = _t;
						this._caching = {
							lastFrame: _t,
							lastIndex: 0,
							value: c("float32", p)
					...
					var Lt = function() {
						function t(t, e, i, s, a) {
							...
							if (e.sid && (e = t.globalData.slotManager.getProp(e)), e.k.length)
								if ("number" == typeof e.k[0]) r = new Ft(t, e, s, a);
								else switch (i) {
									case 0:
										r = new Et(t, e, s, a);
										break;
					...
					function zt() {
						this.c = !1, this._length = 0, this._maxLength = 8, this.v = u(this._maxLength), this.o = u(this._maxLength), this.i = u(this._maxLength)
					}
					zt.prototype.setPathData = function(t, e) {
						...
						this.v = this.v.concat(u(this._maxLength)), this.i = this.i.concat(u(this._maxLength)), this.o = this.o.concat(u(this._maxLength)), this._maxLength *= 2
					}, zt.prototype.setXYAt = function(t, e, i, s, a) {
						var r;
						switch (this._length = Math.max(this._length, s + 1), this._length >= this._maxLength && this.doubleArrayLength(), i) {
							...
							default:
								r = []
						}(!r[s] || r[s] && !a) && (r[s] = Rt.newElement()), r[s][0] = t, r[s][1] = e
					}, zt.prototype.setTripleAt = function(t, e, i, s, a, r, n, o) {
					...
					function Nt() {
						this._length = 0, this._maxLength = 4, this.shapes = u(this._maxLength)
					}
					Nt.prototype.addShape = function(t) {
						this._length === this._maxLength && (this.shapes = this.shapes.concat(u(this._maxLength)), this._maxLength *= 2), this.shapes[this._length] = t, this._length += 1
					}, Nt.prototype.releaseShapes = function() {
						var t;
						for (t = 0; t < this._length; t += 1) Ot.release(this.shapes[t]);
						this._length = 0
					};
					var Bt = function() {
							var t = {
							...
							function a() {
								return e ? s[e -= 1] : new Nt
							}

							function r(t) {
								var a, r = t._length;
								for (a = 0; a < r; a += 1) Ot.release(t.shapes[a]);
								t._length = 0, e === i && (s = ct.double(s), i *= 2), s[e] = t, e += 1
							}
							return t
						}(),
						qt = function() {
							...
							function e(t, e, i) {
								var s, a, r, n, o, h, l, p, f, d = i.lastIndex,
									m = this.keyframes;
								if (t < m[0].t - this.offsetTime) s = m[0].s[0], r = !0, d = 0;
									...
									if (g = this.keyframesMetadata[y] || {}, d = y, !(r = 1 === c.h)) {
										if (t >= u.t - this.offsetTime) p = 1;
											...
											var _;
											g.__fnct ? _ = g.__fnct : (_ = mt.getBezierEasing(c.o.x, c.o.y, c.i.x, c.i.y).get, g.__fnct = _), p = _((t - (c.t - this.offsetTime)) / (u.t - this.offsetTime - (c.t - this.offsetTime)))
										}
										a = u.s ? u.s[0] : c.e[0]
									}
									s = c.s[0]
								...
								for (h = e._length, l = s.i[0].length, i.lastIndex = d, n = 0; n < h; n += 1)
									for (o = 0; o < l; o += 1) f = r ? s.i[n][o] : s.i[n][o] + (a.i[n][o] - s.i[n][o]) * p, e.i[n][o] = f, f = r ? s.o[n][o] : s.o[n][o] + (a.o[n][o] - s.o[n][o]) * p, e.o[n][o] = f, f = r ? s.v[n][o] : s.v[n][o] + (a.v[n][o] - s.v[n][o]) * p, e.v[n][o] = f
							}
							...
							function r(t) {
								a(this.v, t) || (this.v = Ot.clone(t), this.localShapeCollection.releaseShapes(), this.localShapeCollection.addShape(this.v), this._mdf = !0, this.paths = this.localShapeCollection)
							}
							...
							function o(t, e, i) {
								...
								this.v = Ot.clone(a), this.pv = Ot.clone(this.v), this.localShapeCollection = Bt.newShapeCollection(), this.paths = this.localShapeCollection, this.paths.addShape(this.v), this.reset = s, this.effectsSequence = []
							}
							...
							function l(e, a, r) {
								...
								this.v = Ot.newElement(), this.v.setPathData(this.keyframes[0].s[0].c, n), this.pv = Ot.clone(this.v), this.localShapeCollection = Bt.newShapeCollection(), this.paths = this.localShapeCollection, this.paths.addShape(this.v), this.lastFrame = t, this.reset = s, this._caching = {
									lastFrame: t,
									lastIndex: 0
								}, this.effectsSequence = [i.bind(this)]
							}
							o.prototype.interpolateShape = e, o.prototype.getValue = n, o.prototype.setVValue = r, o.prototype.addEffect = h, l.prototype.getValue = n, l.prototype.interpolateShape = e, l.prototype.setVValue = r, l.prototype.addEffect = h;
							var p = function() {
									var t = C;

									function e(t, e) {
										this.v = Ot.newElement(), this.v.setPathData(!0, 4), this.localShapeCollection = Bt.newShapeCollection(), this.paths = this.localShapeCollection, this.localShapeCollection.addShape(this.v), this.d = e.d, this.elem = t, this.comp = t.comp, this.frameId = -1, this.initDynamicPropertyContainer(t), this.p = Lt.getProp(t, e.p, 1, 0, this), this.s = Lt.getProp(t, e.s, 1, 0, this), this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertEllToPath())
									}
									return e.prototype = {
										reset: s,
										getValue: function() {
								...
								d = function() {
									function t(t, e) {
										this.v = Ot.newElement(), this.v.setPathData(!0, 0), this.elem = t, this.comp = t.comp, this.data = e, this.frameId = -1, this.d = e.d, this.initDynamicPropertyContainer(t), 1 === e.sy ? (this.ir = Lt.getProp(t, e.ir, 0, 0, this), this.is = Lt.getProp(t, e.is, 0, .01, this), this.convertToPath = this.convertStarToPath) : this.convertToPath = this.convertPolygonToPath, this.pt = Lt.getProp(t, e.pt, 0, 0, this), this.p = Lt.getProp(t, e.p, 1, 0, this), this.r = Lt.getProp(t, e.r, 0, M, this), this.or = Lt.getProp(t, e.or, 0, 0, this), this.os = Lt.getProp(t, e.os, 0, .01, this), this.localShapeCollection = Bt.newShapeCollection(), this.localShapeCollection.addShape(this.v), this.paths = this.localShapeCollection, this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertToPath())
									}
									return t.prototype = {
										reset: s,
										getValue: function() {
								...
								m = function() {
									function t(t, e) {
										this.v = Ot.newElement(), this.v.c = !0, this.localShapeCollection = Bt.newShapeCollection(), this.localShapeCollection.addShape(this.v), this.paths = this.localShapeCollection, this.elem = t, this.comp = t.comp, this.frameId = -1, this.d = e.d, this.initDynamicPropertyContainer(t), this.p = Lt.getProp(t, e.p, 1, 0, this), this.s = Lt.getProp(t, e.s, 1, 0, this), this.r = Lt.getProp(t, e.r, 0, 0, this), this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertRectToPath())
									}
									return t.prototype = {
							...
							function c(t, e, i) {
								var s;
								return 3 === i || 4 === i ? s = (3 === i ? e.pt : e.ks).k.length ? new l(t, e, i) : new o(t, e, i) : 5 === i ? s = new m(t, e) : 6 === i ? s = new p(t, e) : 7 === i && (s = new d(t, e)), s.k && t.addDynamicProperty(s), s
							}
							...
							var y = {};
							return y.getShapeProp = c, y.getConstructorFunction = u, y.getKeyframedConstructorFunction = g, y
						}(),
						jt = function() {
							var t = Math.cos,
								e = Math.sin,
							...
							function m(t, e, i, s, a, r, n, o, h, l, p, f, d, m, c, u) {
					...
					function Kt() {
						!0 === Ht ? dt.searchAnimations(Yt, Ht, Gt) : dt.searchAnimations()
					}
					...
					function Qt(t) {
						return !0 === Ht && (t.animationData = JSON.parse(Yt)), dt.loadAnimation(t)
					}
					...
					function se() {
						"complete" === document.readyState && (clearInterval(he), Kt())
					}

					function ae(t) {
						for (var e = re.split("&"), i = 0; i < e.length; i += 1) {
							var s = e[i].split("=");
							if (decodeURIComponent(s[0]) == t) return decodeURIComponent(s[1])
						}
						return null
					}
					Xt.play = dt.play, Xt.pause = dt.pause, Xt.setLocationHref = Jt, Xt.togglePause = dt.togglePause, Xt.setSpeed = dt.setSpeed, Xt.setDirection = dt.setDirection, Xt.stop = dt.stop, Xt.searchAnimations = Kt, Xt.registerAnimation = dt.registerAnimation, Xt.loadAnimation = Qt, Xt.setSubframeRendering = Ut, Xt.resize = dt.resize, Xt.goToAndStop = dt.goToAndStop, Xt.destroy = dt.destroy, Xt.setQuality = $t, Xt.inBrowser = te, Xt.installPlugin = ee, Xt.freeze = dt.freeze, Xt.unfreeze = dt.unfreeze, Xt.setVolume = dt.setVolume, Xt.mute = dt.mute, Xt.unmute = dt.unmute, Xt.getRegisteredAnimations = dt.getRegisteredAnimations, Xt.useWebWorker = n, Xt.setIDPrefix = Zt, Xt.__getFactory = ie, Xt.version = "5.12.2";
					var re = "";
					if (Ht) {
						...
						re = oe.src ? oe.src.replace(/^[^\?]+\??/, "") : "", Gt = ae("renderer")
					}
					...
					function de() {}
					pe.prototype.initModifierProperties = function() {}, pe.prototype.addShapeToModifier = function() {}, pe.prototype.addShape = function(t) {
						if (!this.closed) {
							t.sh.container.addDynamicProperty(t.sh);
							var e = {
								shape: t.sh,
								data: t,
								localShapeCollection: Bt.newShapeCollection()
							};
					...
					}, f([Vt], pe), f([pe], fe), fe.prototype.initModifierProperties = function(t, e) {
						this.s = Lt.getProp(t, e.s, 0, .01, this), this.e = Lt.getProp(t, e.e, 0, .01, this), this.o = Lt.getProp(t, e.o, 0, 0, this), this.sValue = 0, this.eValue = 0, this.getValue = this.processKeys, this.m = e.m, this._isAnimated = !!this.s.effectsSequence.length || !!this.e.effectsSequence.length || !!this.o.effectsSequence.length
					}, fe.prototype.addShapeToModifier = function(t) {
						t.pathsData = []
					}, fe.prototype.calculateShapeEdges = function(t, e, i, s, a) {
						var r = [];
						e <= 1 ? r.push({
							s: t,
							e
					...
					}, fe.prototype.releasePathsData = function(t) {
						var e, i = t.length;
						for (e = 0; e < i; e += 1) yt.release(t[e]);
						return t.length = 0, t
						...
						var o, h, l, p, f, d = this.shapes.length,
							m = 0;
						if (i === e)
							...
							for (a = 0; a < d; a += 1)
								if ((c = this.shapes[a]).shape._mdf || this._mdf || t || 2 === this.m) {
									if (h = (s = c.shape.paths)._length, f = 0, !c.shape._mdf && c.pathsData.length) f = c.totalShapeLength;
										...
										for (l = this.releasePathsData(c.pathsData), o = 0; o < h; o += 1) p = bt.getSegmentsLength(s.shapes[o]), l.push(p), f += p.totalLength;
						...
						var s, a, r, n, o, h, l, p, f = t.pathsData,
							...
							u = [],
							g = !0;
						for (i ? (o = i._length, p = i._length) : (i = Ot.newElement(), o = 0, p = 0), u.push(i), s = 0; s < m; s += 1) {
							for (h = f[s].lengths, i.c = d[s].c, r = d[s].c ? h.length : h.length + 1, a = 1; a < r; a += 1)
								if (c + (n = h[a - 1]).addedLength < e.s) c += n.addedLength, i.c = !1;
									...
									e.s <= c && e.e >= c + n.addedLength ? (this.addSegment(d[s].v[a - 1], d[s].o[a - 1], d[s].i[a], d[s].v[a], i, o, g), g = !1) : (l = bt.getNewSegment(d[s].v[a - 1], d[s].v[a], d[s].o[a - 1], d[s].i[a], (e.s - c) / n.addedLength, (e.e - c) / n.addedLength, h[a - 1]), this.addSegmentFromArray(l, i, o, g), g = !1, i.c = !1), c += n.addedLength, o += 1
								} if (d[s].c && h.length) {
								if (n = h[a - 1], c <= e.e) {
									var y = h[a - 1].addedLength;
									e.s <= c && e.e >= c + y ? (this.addSegment(d[s].v[a - 1], d[s].o[a - 1], d[s].i[0], d[s].v[0], i, o, g), g = !1) : (l = bt.getNewSegment(d[s].v[a - 1], d[s].v[0], d[s].o[a - 1], d[s].i[0], (e.s - c) / y, (e.e - c) / y, h[a - 1]), this.addSegmentFromArray(l, i, o, g), g = !1, i.c = !1)
								} else i.c = !1;
								c += n.addedLength, o += 1
							}
							if (i._length && (i.setXYAt(i.v[p][0], i.v[p][1], "i", p), i.setXYAt(i.v[i._length - 1][0], i.v[i._length - 1][1], "o", i._length - 1)), c > e.e) break;
							s < m - 1 && (i = Ot.newElement(), g = !0, u.push(i), o = 0)
						}
						return u
					}, f([pe], de), de.prototype.initModifierProperties = function(t, e) {
						this.getValue = this.processKeys, this.amount = Lt.getProp(t, e.a, 0, null, this), this._isAnimated = !!this.amount.effectsSequence.length
						...
						s[0] /= a, s[1] /= a;
						var n, o, h, l, p, f, d = Ot.newElement();
					...
					var me = function() {
						...
						function n(t, e, i) {
							if (this.elem = t, this.frameId = -1, this.propType = "transform", this.data = e, this.v = new jt, this.pre = new jt, this.appliedTransformations = 0, this.initDynamicPropertyContainer(i || t), e.p && e.p.s ? (this.px = Lt.getProp(t, e.p.x, 0, 0, this), this.py = Lt.getProp(t, e.p.y, 0, 0, this), e.p.z && (this.pz = Lt.getProp(t, e.p.z, 0, 0, this))) : this.p = Lt.getProp(t, e.p || {
									k: [0, 0, 0]
								}, 1, 0, this), e.rx) {
								if (this.rx = Lt.getProp(t, e.rx, 0, M, this), this.ry = Lt.getProp(t, e.ry, 0, M, this), this.rz = Lt.getProp(t, e.rz, 0, M, this), e.or.k[0].ti) {
									var s, a = e.or.k.length;
									for (s = 0; s < a; s += 1) e.or.k[s].to = null, e.or.k[s].ti = null
								}
								this.or = Lt.getProp(t, e.or, 1, M, this), this.or.sh = !0
							} else this.r = Lt.getProp(t, e.r || {
								k: 0
							}, 0, M, this);
							e.sk && (this.sk = Lt.getProp(t, e.sk, 0, M, this), this.sa = Lt.getProp(t, e.sa, 0, M, this)), this.a = Lt.getProp(t, e.a || {
								k: [0, 0, 0]
							}, 1, 0, this), this.s = Lt.getProp(t, e.s || {
								k: [100, 100, 100]
							}, 1, .01, this), e.o ? this.o = Lt.getProp(t, e.o, 0, .01, t) : this.o = {
								_mdf: !1,
								v: 1
						...
						return n.prototype = {
							...
							autoOrient: a
						}, f([Vt], n), n.prototype.addDynamicProperty = r, n.prototype._addDynamicProperty = Vt.prototype.addDynamicProperty, {
					...
					function be(t, e, i) {
						return [ve(t[0], e[0], i), ve(t[1], e[1], i)]
					}
					...
					function Pe(t) {
						return new Ae(t, t, t, t, !1)
					}

					function Ae(t, e, i, s, a) {
						a && Ie(t, e) && (e = be(t, s, 1 / 3)), a && Ie(i, s) && (i = be(t, s, 2 / 3));
						var r = ke(t[0], e[0], i[0], s[0]),
							n = ke(t[1], e[1], i[1], s[1]);
					...
					function Se(t, e) {
						...
						for (var r = _e(3 * t.a[e], 2 * t.b[e], t.c[e]), n = 0; n < r.length; n += 1)
							if (r[n] > 0 && r[n] < 1) {
								var o = t.point(r[n])[e];
								o < i ? i = o : o > s && (s = o)
							} return {
					...
					function Me(t, e, i, s, a, r) {
						if (De(t, e))
							if (i >= r || t.width <= s && t.height <= s && e.width <= s && e.height <= s) a.push([t.t, e.t]);
								...
								var n = we(t),
									o = we(e);
								Me(n[0], o[0], i + 1, s, a, r), Me(n[0], o[1], i + 1, s, a, r), Me(n[1], o[0], i + 1, s, a, r), Me(n[1], o[1], i + 1, s, a, r)
							}
					}
					...
					function Te(t, e, i, s) {
						var a = [t[0], t[1], 1],
							...
							o = [s[0], s[1], 1],
							h = Ce(Ce(a, r), Ce(n, o));
						return ye(h[2]) ? null : [h[0] / h[2], h[1] / h[2]]
					}
					...
					function Oe(t, e, i, s, a, r, n) {
						...
						Ve(t, e.v[i % e._length], o, n, s, d / (2 * (a + 1)), f / (2 * (a + 1)), r)
					}

					function Ne(t, e, i, s, a, r) {
						for (var n = 0; n < s; n += 1) {
							var o = (n + 1) / (s + 1),
								h = 2 === a ? Math.sqrt(Math.pow(e.points[3][0] - e.points[0][0], 2) + Math.pow(e.points[3][1] - e.points[0][1], 2)) : 0,
								l = e.normalAngle(o);
							Ve(t, e.point(o), l, r, i, h / (2 * (s + 1)), h / (2 * (s + 1)), a), r = -r
						}
						return r
					}
					...
					function Be(t, e, i) {
						...
						return [Fe(t, s, i), Fe(e, s, i)]
					}

					function qe(t, e) {
						var i, s, a, r, n, o, h;
						i = (h = Be(t.points[0], t.points[1], e))[0], s = h[1], a = (h = Be(t.points[1], t.points[2], e))[0], r = h[1], n = (h = Be(t.points[2], t.points[3], e))[0], o = h[1];
						var l = Te(i, s, a, r);
						null === l && (l = s);
						var p = Te(n, o, a, r);
						return null === p && (p = n), new Ae(i, l, p, o)
					}

					function je(t, e, i, s, a) {
						var r = e.points[3],
							n = i.points[0];
						if (3 === s) return r;
						if (Ie(r, n)) return r;
						if (2 === s) {
							var o = -e.tangentAngle(1),
								...
								l = Te(r, Fe(r, o + Math.PI / 2, 100), n, Fe(n, o + Math.PI / 2, 100)),
								p = l ? Ee(l, r) : Ee(r, n) / 2,
								f = Fe(r, o, 2 * p * C);
							return t.setXYAt(f[0], f[1], "o", t.length() - 1), f = Fe(n, h, 2 * p * C), t.setTripleAt(n[0], n[1], n[0], n[1], f[0], f[1], t.length()), n
						}
						var d = Te(Ie(r, e.points[2]) ? e.points[0] : e.points[2], r, n, Ie(n, i.points[1]) ? i.points[3] : i.points[1]);
						return d && Ee(d, r) < a ? (t.setTripleAt(d[0], d[1], d[0], d[1], d[0], d[1], t.length()), d) : r
					}
					...
					function Xe(t, e) {
						var i = t.slice(),
							s = e.slice(),
							a = We(t[t.length - 1], e[0]);
						return a && (i[t.length - 1] = t[t.length - 1].split(a[0])[0], s[0] = e[0].split(a[1])[1]), t.length > 1 && e.length > 1 && (a = We(t[0], e[e.length - 1])) ? [
							[t[0].split(a[0])[0]],
					...
					function He(t) {
						for (var e, i = 1; i < t.length; i += 1) e = Xe(t[i - 1], t[i]), t[i - 1] = e[0], t[i] = e[1];
						return t.length > 1 && (e = Xe(t[t.length - 1], t[0]), t[t.length - 1] = e[0], t[0] = e[1]), t
					}

					function Ye(t, e) {
						var i, s, a, r, n = t.inflectionPoints();
						if (0 === n.length) return [qe(t, e)];
						if (1 === n.length || ge(n[1], 1)) return i = (a = t.split(n[0]))[0], s = a[1], [qe(i, e), qe(s, e)];
						i = (a = t.split(n[0]))[0];
						var o = (n[1] - n[0]) / (1 - n[0]);
						return r = (a = a[1].split(o))[0], s = a[1], [qe(i, e), qe(r, e), qe(s, e)]
					}
					...
					f([pe], ce), ce.prototype.initModifierProperties = function(t, e) {
						this.getValue = this.processKeys, this.c = Lt.getProp(t, e.c, 0, null, this), this.o = Lt.getProp(t, e.o, 0, null, this), this.tr = me.getTransformProperty(t, e.tr, this), this.so = Lt.getProp(t, e.tr.so, 0, .01, this), this.eo = Lt.getProp(t, e.tr.eo, 0, .01, this), this.data = e, this.dynamicProperties.length || this.getValue(!0), this._isAnimated = !!this.dynamicProperties.length, this.pMatrix = new jt, this.rMatrix = new jt, this.sMatrix = new jt, this.tMatrix = new jt, this.matrix = new jt
					}, ce.prototype.applyTransforms = function(t, e, i, s, a, r) {
						var n = r ? -1 : 1,
					...
					}, ce.prototype.init = function(t, e, i, s) {
					...
					}, ce.prototype.resetElements = function(t) {
						var e, i = t.length;
						for (e = 0; e < i; e += 1) t[e]._processed = !1, "gr" === t[e].ty && this.resetElements(t[e].it)
					}, ce.prototype.cloneElements = function(t) {
						var e = JSON.parse(JSON.stringify(t));
						return this.resetElements(e), e
					}, ce.prototype.changeGroupRender = function(t, e) {
						var i, s = t.length;
						...
						return n
					}, ce.prototype.addShape = function() {}, f([pe], ue), ue.prototype.initModifierProperties = function(t, e) {
						this.getValue = this.processKeys, this.rd = Lt.getProp(t, e.r, 0, null, this), this._isAnimated = !!this.rd.effectsSequence.length
					}, ue.prototype.processPath = function(t, e) {
						var i, s = Ot.newElement();
						s.c = t.c;
						var a, r, n, o, h, l, p, f, d, m, c, u, g = t._length,
							y = 0;
						for (i = 0; i < g; i += 1) a = t.v[i], n = t.o[i], r = t.i[i], a[0] === n[0] && a[1] === n[1] && a[0] === r[0] && a[1] === r[1] ? 0 !== i && i !== g - 1 || t.c ? (o = 0 === i ? t.v[g - 1] : t.v[i - 1], l = (h = Math.sqrt(Math.pow(a[0] - o[0], 2) + Math.pow(a[1] - o[1], 2))) ? Math.min(h / 2, e) / h : 0, p = c = a[0] + (o[0] - a[0]) * l, f = u = a[1] - (a[1] - o[1]) * l, d = p - (p - a[0]) * C, m = f - (f - a[1]) * C, s.setTripleAt(p, f, d, m, c, u, y), y += 1, o = i === g - 1 ? t.v[0] : t.v[i + 1], l = (h = Math.sqrt(Math.pow(a[0] - o[0], 2) + Math.pow(a[1] - o[1], 2))) ? Math.min(h / 2, e) / h : 0, p = d = a[0] + (o[0] - a[0]) * l, f = m = a[1] + (o[1] - a[1]) * l, c = p - (p - a[0]) * C, u = f - (f - a[1]) * C, s.setTripleAt(p, f, d, m, c, u, y), y += 1) : (s.setTripleAt(a[0], a[1], n[0], n[1], r[0], r[1], y), y += 1) : (s.setTripleAt(t.v[i][0], t.v[i][1], t.o[i][0], t.o[i][1], t.i[i][0], t.i[i][1], y), y += 1);
						return s
						...
						this.dynamicProperties.length || (this._mdf = !1)
					}, Ae.prototype.point = function(t) {
						return [((this.a[0] * t + this.b[0]) * t + this.c[0]) * t + this.d[0], ((this.a[1] * t + this.b[1]) * t + this.c[1]) * t + this.d[1]]
					}, Ae.prototype.derivative = function(t) {
						return [(3 * t * this.a[0] + 2 * this.b[0]) * t + this.c[0], (3 * t * this.a[1] + 2 * this.b[1]) * t + this.c[1]]
					}, Ae.prototype.tangentAngle = function(t) {
						var e = this.derivative(t);
						return Math.atan2(e[1], e[0])
					}, Ae.prototype.normalAngle = function(t) {
						var e = this.derivative(t);
						return Math.atan2(e[0], e[1])
					}, Ae.prototype.inflectionPoints = function() {
						...
						if (i < 0) return [];
						var s = Math.sqrt(i);
						return ye(s) ? s > 0 && s < 1 ? [e] : [] : [e - s, e + s].filter((function(t) {
							return t > 0 && t < 1
						}))
					}, Ae.prototype.split = function(t) {
						if (t <= 0) return [Pe(this.points[0]), this];
						if (t >= 1) return [this, Pe(this.points[this.points.length - 1])];
						var e = be(this.points[0], this.points[1], t),
							i = be(this.points[1], this.points[2], t),
							s = be(this.points[2], this.points[3], t),
							a = be(e, i, t),
							r = be(i, s, t),
							n = be(a, r, t);
						return [new Ae(this.points[0], e, a, n, !0), new Ae(n, r, s, this.points[3], !0)]
					}, Ae.prototype.bounds = function() {
						return {
							x: Se(this, 0),
							y: Se(this, 1)
						}
					}, Ae.prototype.boundingBox = function() {
						var t = this.bounds();
						return {
							left: t.x.min,
							right: t.x.max,
					...
					}, Ae.prototype.intersections = function(t, e, i) {
						void 0 === e && (e = 2), void 0 === i && (i = 7);
						var s = [];
						return Me(xe(this, 0, 1), xe(t, 0, 1), 0, e, s, i), s
					}, Ae.shapeSegment = function(t, e) {
						var i = (e + 1) % t.length();
						return new Ae(t.v[e], t.o[e], t.i[i], t.v[i], !0)
					}, Ae.shapeSegmentInverted = function(t, e) {
						var i = (e + 1) % t.length();
						return new Ae(t.v[i], t.i[i], t.o[e], t.v[e], !0)
					}, f([pe], Le), Le.prototype.initModifierProperties = function(t, e) {
						this.getValue = this.processKeys, this.amplitude = Lt.getProp(t, e.s, 0, null, this), this.frequency = Lt.getProp(t, e.r, 0, null, this), this.pointsType = Lt.getProp(t, e.pt, 0, null, this), this._isAnimated = 0 !== this.amplitude.effectsSequence.length || 0 !== this.frequency.effectsSequence.length || 0 !== this.pointsType.effectsSequence.length
					}, Le.prototype.processPath = function(t, e, i, s) {
						var a = t._length,
							r = Ot.newElement();
						if (r.c = t.c, t.c || (a -= 1), 0 === a) return r;
						var n = -1,
							o = Ae.shapeSegment(t, 0);
						Oe(r, t, 0, e, i, s, n);
						for (var h = 0; h < a; h += 1) n = Ne(r, o, e, i, s, -n), o = h !== a - 1 || t.c ? Ae.shapeSegment(t, (h + 1) % a) : null, Oe(r, t, h + 1, e, i, s, n);
						return r
						...
						this.dynamicProperties.length || (this._mdf = !1)
					}, f([pe], Ge), Ge.prototype.initModifierProperties = function(t, e) {
						this.getValue = this.processKeys, this.amount = Lt.getProp(t, e.a, 0, null, this), this.miterLimit = Lt.getProp(t, e.ml, 0, null, this), this.lineJoin = e.lj, this._isAnimated = 0 !== this.amount.effectsSequence.length
						...
						t.c || (h -= 1);
						var l = [];
						for (r = 0; r < h; r += 1) o = Ae.shapeSegment(t, r), l.push(Ye(o, e));
						if (!t.c)
							for (r = h - 1; r >= 0; r -= 1) o = Ae.shapeSegmentInverted(t, r), l.push(Ye(o, e));
						l = He(l);
						var p = null,
							f = null;
						for (r = 0; r < l.length; r += 1) {
							var d = l[r];
							for (f && (p = je(a, f, d[0], i, s)), f = d[d.length - 1], n = 0; n < d.length; n += 1) o = d[n], p && Ie(o.points[0], p) ? a.setXYAt(o.points[1][0], o.points[1][1], "o", a.length() - 1) : a.setTripleAt(o.points[0][0], o.points[0][1], o.points[1][0], o.points[1][1], o.points[0][0], o.points[0][1], a.length()), a.setTripleAt(o.points[3][0], o.points[3][1], o.points[3][0], o.points[3][1], o.points[2][0], o.points[2][1], a.length()), p = o.points[3]
						}
						return l.length && je(a, f, l[0][0], i, s), a
					...
					var Ke = function() {
						...
						function c(t, e) {
							...
							var a = s.offsetWidth;
							return s.style.fontFamily = m(t) + ", " + e, {
								node: s,
								w: a,
								parent: i
							}
						...
						function y(t, e) {
							if (t) {
								...
								for (i = 0; i < a; i += 1) {
									var n, o, h = !0;
									if (s[i].loaded = !1, s[i].monoCase = c(s[i].fFamily, "monospace"), s[i].sansCase = c(s[i].fFamily, "sans-serif"), s[i].fPath) {
										if ("p" === s[i].fOrigin || 3 === s[i].origin) {
											if ((n = document.querySelectorAll('style[f-forigin="p"][f-family="' + s[i].fFamily + '"], style[f-origin="3"][f-family="' + s[i].fFamily + '"]')).length > 0 && (h = !1), h) {
												var l = p("style");
											...
											for (n = document.querySelectorAll('link[f-forigin="g"], link[f-origin="1"]'), o = 0; o < n.length; o += 1) - 1 !== n[o].href.indexOf(s[i].fPath) && (h = !1);
											if (h) {
												var f = p("link");
												f.setAttribute("f-forigin", s[i].fOrigin), f.setAttribute("f-origin", s[i].origin), f.type = "text/css", f.rel = "stylesheet", f.href = s[i].fPath, document.body.appendChild(f)
											}
										} else if ("t" === s[i].fOrigin || 2 === s[i].origin) {
											for (n = document.querySelectorAll('script[f-forigin="t"], script[f-origin="2"]'), o = 0; o < n.length; o += 1) s[i].fPath === n[o].src && (h = !1);
											if (h) {
												var d = p("link");
						...
						function D(t) {
							return w(t.substr(0, 2)) && w(t.substr(2, 2))
						}
						...
						function C(t, e) {
							...
							var o = 0;
							for (e += 2; o < 5;) {
								if ((i = P(t.substr(e, 2))) < r || i > n) return !1;
								o += 1, e += 2
							}
							return P(t.substr(e, 2)) === a
						}
						...
						F.isModifier = A, F.isZeroWidthJoiner = S, F.isFlagEmoji = D, F.isRegionalCode = w, F.isCombinedCharacter = M, F.isRegionalFlag = C, F.isVariationSelector = x, F.BLACK_FLAG_CODE_POINT = s;
						var E = {
							addChars: v,
							addFonts: y,
							getCharData: b,
					...
					function Qe() {}
					Ue.prototype.getProp = function(t) {
					...
					function li(t, e) {
						...
						this.effectElements = [];
						var a, r = s.length;
						for (i = 0; i < r; i += 1) a = new pi(s[i], e), this.effectElements.push(a)
					}
					...
					function ci(t, e, i) {
						...
						this.audio = this.globalData.audioController.createAudio(s), this._currentTime = 0, this.globalData.audioController.addAudio(this), this._volumeMultiplier = 1, this._volume = 1, this._previousVolume = null, this.tm = t.tm ? Lt.getProp(this, t.tm, 0, e.frameRate, this) : {
							_placeholder: !0
						}, this.lv = Lt.getProp(this, t.au && t.au.lv ? t.au.lv : {
							k: [100]
						}, 1, .01, this)
					}

					function ui() {}
					f([Vt], pi), pi.prototype.getValue = pi.prototype.iterateDynamicProperties, pi.prototype.init = function(t, e) {
						var i;
						...
						initBaseData: function(t, e, i) {
							this.globalData = e, this.comp = i, this.data = t, this.layerId = N(), this.data.sr || (this.data.sr = 1), this.effectsManager = new li(this.data, this, this.dynamicProperties)
						},
						getType: function() {
							return this.type
						},
					...
					}, mi.prototype.prepareFrame = function() {}, f([Qe, fi, di], mi), mi.prototype.getBaseElement = function() {
						return null
					}, mi.prototype.renderFrame = function() {}, mi.prototype.destroy = function() {}, mi.prototype.initExpressions = function() {
						var t = K();
						if (t) {
							var e = t("footage");
							this.layerInterface = e(this)
						}
					}, mi.prototype.getFootageData = function() {
					...
					}, f([Qe, fi, di], ci), ci.prototype.renderFrame = function() {
						this.isInRange && this._canPlay && (this._isPlaying ? (!this.audio.playing() || Math.abs(this._currentTime / this.globalData.frameRate - this.audio.seek()) > .1) && this.audio.seek(this._currentTime / this.globalData.frameRate) : (this.audio.play(), this.audio.seek(this._currentTime / this.globalData.frameRate), this._isPlaying = !0))
					}, ci.prototype.show = function() {}, ci.prototype.hide = function() {
						this.audio.pause(), this._isPlaying = !1
					}, ci.prototype.pause = function() {
						this.audio.pause(), this._isPlaying = !1, this._canPlay = !1
					}, ci.prototype.resume = function() {
						this._canPlay = !0
					}, ci.prototype.setRate = function(t) {
						this.audio.rate(t)
					}, ci.prototype.volume = function(t) {
						this._volumeMultiplier = t, this._previousVolume = t * this._volume, this.audio.volume(this._previousVolume)
					}, ci.prototype.getBaseElement = function() {
						return null
					}, ci.prototype.destroy = function() {}, ci.prototype.sourceRectAtTime = function() {}, ci.prototype.initExpressions = function() {}, ui.prototype.checkLayers = function(t) {
					...
					}, ui.prototype.createItem = function(t) {
						switch (t.ty) {
							case 2:
					...
					}, ui.prototype.createCamera = function() {
						throw new Error("You're using a 3d camera. Try the html renderer.")
					}, ui.prototype.createAudio = function(t) {
						return new ci(t, this.globalData, this)
					}, ui.prototype.createFootage = function(t) {
						return new mi(t, this.globalData, this)
					}, ui.prototype.buildAllItems = function() {
						var t, e = this.layers.length;
						for (t = 0; t < e; t += 1) this.buildItem(t);
						this.checkPendingElements()
					}, ui.prototype.includeLayers = function(t) {
						var e;
					...
					}, ui.prototype.setProjectInterface = function(t) {
						this.globalData.projectInterface = t
					}, ui.prototype.initItems = function() {
						this.globalData.progressiveLoad || this.buildAllItems()
					}, ui.prototype.buildElementParenting = function(t, e, i) {
					...
					}, ui.prototype.addPendingElement = function(t) {
						this.pendingElements.push(t)
					}, ui.prototype.searchExtraCompositions = function(t) {
						var e, i = t.length;
						for (e = 0; e < i; e += 1)
							if (t[e].xt) {
					...
					}, ui.prototype.setupGlobalData = function(t, e) {
						this.globalData.fontManager = new Ke, this.globalData.slotManager = Ze(t), this.globalData.fontManager.addChars(t.chars), this.globalData.fontManager.addFonts(t.fonts, e), this.globalData.getAssetData = this.animationItem.getAssetData.bind(this.animationItem), this.globalData.getAssetsPath = this.animationItem.getAssetsPath.bind(this.animationItem), this.globalData.imageLoader = this.animationItem.imagePreloader, this.globalData.audioController = this.animationItem.audioController, this.globalData.frameId = 0, this.globalData.frameRate = t.fr, this.globalData.nm = t.nm, this.globalData.compSize = {
							w: t.w,
							h: t.h
						}
					};
					...
					function vi(t, e, i) {
						...
						var s, a, r = this.globalData.defs,
							n = this.masksProperties ? this.masksProperties.length : 0;
						this.viewData = u(n), this.solidPath = "";
						var o, h, p, f, d, m, c = this.masksProperties,
							g = 0,
							y = [],
							v = N(),
							b = "clipPath",
							_ = "clip-path";
						for (s = 0; s < n; s += 1)
							if (("a" !== c[s].mode && "n" !== c[s].mode || c[s].inv || 100 !== c[s].o.k || c[s].o.x) && (b = "mask", _ = "mask"), "s" !== c[s].mode && "i" !== c[s].mode || 0 !== g ? p = null : ((p = $("rect")).setAttribute("fill", "#ffffff"), p.setAttribute("width", this.element.comp.data.w || 0), p.setAttribute("height", this.element.comp.data.h || 0), y.push(p)), a = $("path"), "n" === c[s].mode) this.viewData[s] = {
								op: Lt.getProp(this.element, c[s].o, 0, .01, this.element),
								prop: qt.getShapeProp(this.element, c[s], 3),
								elem: a,
								lastPath: ""
							}, r.appendChild(a);
							else {
								var k;
								if (g += 1, a.setAttribute("fill", "s" === c[s].mode ? "#000000" : "#ffffff"), a.setAttribute("clip-rule", "nonzero"), 0 !== c[s].x.k ? (b = "mask", _ = "mask", m = Lt.getProp(this.element, c[s].x, 0, null, this.element), k = N(), (f = $("filter")).setAttribute("id", k), (d = $("feMorphology")).setAttribute("operator", "erode"), d.setAttribute("in", "SourceGraphic"), d.setAttribute("radius", "0"), f.appendChild(d), r.appendChild(f), a.setAttribute("stroke", "s" === c[s].mode ? "#000000" : "#ffffff")) : (d = null, m = null), this.storedData[s] = {
										elem: a,
										x: m,
										expan: d,
										lastPath: "",
									...
									h = y.length;
									var P = $("g");
									for (o = 0; o < h; o += 1) P.appendChild(y[o]);
									var A = $("mask");
									A.setAttribute("mask-type", "alpha"), A.setAttribute("id", v + "_" + g), A.appendChild(a), r.appendChild(A), P.setAttribute("mask", "url(" + l() + "#" + v + "_" + g + ")"), y.length = 0, y.push(P)
								} else y.push(a);
							...
							} for (this.maskElement = $(b), n = y.length, s = 0; s < n; s += 1) this.maskElement.appendChild(y[s]);
						g > 0 && (this.maskElement.setAttribute("id", v), this.element.maskedElement.setAttribute(_, "url(" + l() + "#" + v + ")"), r.appendChild(this.maskElement)), this.viewData.length && this.element.addRenderableComponent(this)
					}
					yi.prototype = {
						...
						searchEffectTransforms: function() {
							if (this.renderableEffectsManager) {
								...
								if (t.length) {
									this.localTransforms = [], this.finalTransform.localMat = new jt;
									var e = 0,
										i = t.length;
						...
						mHelper: new jt
					}, vi.prototype.getMaskProperty = function(t) {
					...
					}, vi.prototype.getMaskelement = function() {
						return this.maskElement
					}, vi.prototype.createLayerSolidPath = function() {
						var t = "M0,0 ";
						return t += " h" + this.globalData.compSize.w, t += " v" + this.globalData.compSize.h, t += " h-" + this.globalData.compSize.w, t += " v-" + this.globalData.compSize.h + " "
					}, vi.prototype.drawPath = function(t, e, i) {
					...
					var bi, _i = function() {
						...
						}, (/MSIE 10/i.test(navigator.userAgent) || /MSIE 9/i.test(navigator.userAgent) || /rv:11.0/i.test(navigator.userAgent) || /Edge\/\d./i.test(navigator.userAgent)) && (bi.maskType = !1), /firefox/i.test(navigator.userAgent) && (bi.svgLumaHidden = !1), bi),
						Pi = {},
						Ai = "filter_result_";
					...
					function Si(t) {
						var e, i, s = "SourceGraphic",
							...
							r = N(),
							n = _i.createFilter(r, !0),
							o = 0;
						for (this.filters = [], e = 0; e < a; e += 1) {
							i = null;
							var h = t.data.ef[e].ty;
							Pi[h] && (i = new(0, Pi[h].effect)(n, t.effectsManager.effectElements[e], t, Ai + o, s), s = Ai + o, Pi[h].countsAsEffect && (o += 1)), i && this.filters.push(i)
						}
						o && (t.globalData.defs.appendChild(n), t.layerElement.setAttribute("filter", "url(" + l() + "#" + r + ")")), this.filters.length && t.addRenderableComponent(this)
					}
					...
					Si.prototype.renderFrame = function(t) {
					...
					}, Si.prototype.getEffects = function(t) {
						var e, i = this.filters.length,
							s = [];
						...
						createContainerElements: function() {
							...
							if (this.data.ln && this.layerElement.setAttribute("id", this.data.ln), this.data.cl && this.layerElement.setAttribute("class", this.data.cl), 0 === this.data.ty && !this.data.hd) {
								...
								if (i.setAttribute("id", a), i.appendChild(s), this.globalData.defs.appendChild(i), this.checkMasks()) {
									var r = $("g");
									r.setAttribute("clip-path", "url(" + l() + "#" + a + ")"), r.appendChild(this.layerElement), this.transformedElement = r, t ? t.appendChild(this.transformedElement) : this.baseElement = this.transformedElement
								} else this.layerElement.setAttribute("clip-path", "url(" + l() + "#" + a + ")")
							}
						...
						createRenderableComponents: function() {
							this.maskManager = new vi(this.data, this, this.globalData), this.renderableEffectsManager = new Si(this), this.searchEffectTransforms()
						},
						getMatte: function(t) {
							if (this.matteMasks || (this.matteMasks = {}), !this.matteMasks[t]) {
								...
								if (1 === t || 3 === t) {
									var n = $("mask");
									n.setAttribute("id", r), n.setAttribute("mask-type", 3 === t ? "luminance" : "alpha"), (s = $("use")).setAttributeNS("http://www.w3.org/1999/xlink", "href", "#" + this.layerId), n.appendChild(s), this.globalData.defs.appendChild(n), ki.maskType || 1 !== t || (n.setAttribute("mask-type", "luminance"), e = N(), i = _i.createFilter(e), this.globalData.defs.appendChild(i), i.appendChild(_i.createAlphaToLuminanceFilter()), (a = $("g")).appendChild(s), n.appendChild(a), a.setAttribute("filter", "url(" + l() + "#" + e + ")"))
								} else if (2 === t) {
									var o = $("mask");
									o.setAttribute("id", r), o.setAttribute("mask-type", "alpha");
									var h = $("g");
									o.appendChild(h), e = N(), i = _i.createFilter(e);
									var p = $("feComponentTransfer");
									...
									var d = $("rect");
									d.setAttribute("width", this.comp.data.w), d.setAttribute("height", this.comp.data.h), d.setAttribute("x", "0"), d.setAttribute("y", "0"), d.setAttribute("fill", "#ffffff"), d.setAttribute("opacity", "0"), h.setAttribute("filter", "url(" + l() + "#" + e + ")"), h.appendChild(d), (s = $("use")).setAttributeNS("http://www.w3.org/1999/xlink", "href", "#" + this.layerId), h.appendChild(s), ki.maskType || (o.setAttribute("mask-type", "luminance"), i.appendChild(_i.createAlphaToLuminanceFilter()), a = $("g"), h.appendChild(d), a.appendChild(this.layerElement), h.appendChild(a)), this.globalData.defs.appendChild(o)
								}
								this.matteMasks[t] = r
							}
					...
					})], Di), f([fi, yi, xi, wi, di, Di], Mi), Mi.prototype.createContent = function() {
					...
					function Vi(t, e, i, s) {
						var a;
						this.elem = t, this.frameId = -1, this.dataProps = u(e.length), this.renderer = i, this.k = !1, this.dashStr = "", this.dashArray = c("float32", e.length ? e.length - 1 : 0), this.dashoffset = c("float32", 1), this.initDynamicPropertyContainer(s);
						var r, n = e.length || 0;
						for (a = 0; a < n; a += 1) r = Lt.getProp(t, e[a].v, 0, 0, this), this.k = r.k || this.k, this.dataProps[a] = {
							n: e[a].n,
							p: r
						};
					...
					function Ri(t, e, i) {
						this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.o = Lt.getProp(t, e.o, 0, .01, this), this.w = Lt.getProp(t, e.w, 0, null, this), this.d = new Vi(t, e.d || {}, "svg", this), this.c = Lt.getProp(t, e.c, 1, 255, this), this.style = i, this._isAnimated = !!this._isAnimated
					}

					function zi(t, e, i) {
						this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.o = Lt.getProp(t, e.o, 0, .01, this), this.c = Lt.getProp(t, e.c, 1, 255, this), this.style = i
					}
					...
					function Ni(t, e, i) {
						...
						this.o = c("float32", s), this._cmdf = !1, this._omdf = !1, this._collapsable = this.checkCollapsable(), this._hasOpacity = s, this.initDynamicPropertyContainer(i), this.prop = Lt.getProp(t, e.k, 1, null, this), this.k = this.prop.k, this.getValue(!0)
					}
					...
					function qi(t, e, i) {
						this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.w = Lt.getProp(t, e.w, 0, null, this), this.d = new Vi(t, e.d || {}, "svg", this), this.initGradientData(t, e, i), this._isAnimated = !!this._isAnimated
					}
					...
					Ii.prototype.setAsAnimated = function() {
					...
					}, f([Vt], Vi), f([Vt], Ri), f([Vt], zi), f([Vt], Oi), Ni.prototype.comparePoints = function(t, e) {
						for (var i = 0, s = this.o.length / 2; i < s;) {
							if (Math.abs(t[4 * i] - t[4 * e + 2 * i]) > .01) return !1;
							i += 1
						}
						return !0
					}, Ni.prototype.checkCollapsable = function() {
					...
					}, f([Vt], Ni), Bi.prototype.initGradientData = function(t, e, i) {
						this.o = Lt.getProp(t, e.o, 0, .01, this), this.s = Lt.getProp(t, e.s, 1, null, this), this.e = Lt.getProp(t, e.e, 1, null, this), this.h = Lt.getProp(t, e.h || {
							k: 0
						}, 0, .01, this), this.a = Lt.getProp(t, e.a || {
							k: 0
						}, 0, M, this), this.g = new Ni(t, e.g, this), this.style = i, this.stops = [], this.setGradientData(i.pElem, e), this.setGradientOpacity(e, i), this._isAnimated = !!this._isAnimated
					}, Bi.prototype.setGradientData = function(t, e) {
						var i = N(),
							s = $(1 === e.t ? "linearGradient" : "radialGradient");
						s.setAttribute("id", i), s.setAttribute("spreadMethod", "pad"), s.setAttribute("gradientUnits", "userSpaceOnUse");
						var a, r, n, o = [];
						for (n = 4 * e.g.p, r = 0; r < n; r += 4) a = $("stop"), s.appendChild(a), o.push(a);
						t.setAttribute("gf" === e.ty ? "fill" : "stroke", "url(" + l() + "#" + i + ")"), this.gf = s, this.cst = o
					}, Bi.prototype.setGradientOpacity = function(t, e) {
						if (this.g._hasOpacity && !this.g._collapsable) {
							...
							var o = N(),
								h = N();
							r.setAttribute("id", h);
							var p = $(1 === t.t ? "linearGradient" : "radialGradient");
							...
							var f = this.stops;
							for (s = 4 * t.g.p; s < a; s += 2)(i = $("stop")).setAttribute("stop-color", "rgb(255,255,255)"), p.appendChild(i), f.push(i);
							n.setAttribute("gf" === t.ty ? "fill" : "stroke", "url(" + l() + "#" + o + ")"), "gs" === t.ty && (n.setAttribute("stroke-linecap", Fi[t.lc || 2]), n.setAttribute("stroke-linejoin", Ei[t.lj || 2]), 1 === t.lj && n.setAttribute("stroke-miterlimit", t.ml)), this.of = p, this.ms = r, this.ost = f, this.maskId = h, e.msElem = n
						}
					}, f([Vt], Bi), f([Bi, Vt], qi);
					var Xi = function(t, e, i, s) {
							if (0 === e) return "";
							var a, r = t.o,
								n = t.i,
								o = t.v,
						...
						Hi = function() {
							...
							function r(i, s, a) {
								var r, n, o, h, l, p, f, d, m, c, u = s.styles.length,
									g = s.lvl;
								for (p = 0; p < u; p += 1) {
									if (h = s.sh._mdf || a, s.styles[p].lvl < g) {
										...
										if (h)
											for (m = g - s.styles[p].lvl, c = s.transformers.length - 1; m > 0;) d.multiply(s.transformers[c].mProps.v), m -= 1, c -= 1
									} else d = t;
									if (n = (f = s.sh.paths)._length, h) {
										for (o = "", r = 0; r < n; r += 1)(l = f.shapes[r]) && l._length && (o += Xi(l, l._length, l.c, d));
										s.caches[p] = o
									} else o = s.caches[p];
							...
							function n(t, e, i) {
								var s = e.style;
								(e.c._mdf || i) && s.pElem.setAttribute("fill", "rgb(" + S(e.c.v[0]) + "," + S(e.c.v[1]) + "," + S(e.c.v[2]) + ")"), (e.o._mdf || i) && s.pElem.setAttribute("fill-opacity", e.o.v)
							}
					...
					function Ji(t, e) {
						this._frameId = r, this.pv = "", this.v = "", this.kf = !1, this._isFirstFrame = !0, this._mdf = !1, e.d && e.d.sid && (e.d = t.globalData.slotManager.getProp(e.d)), this.data = e, this.elem = t, this.comp = this.elem.comp, this.keysIndex = 0, this.canResize = !1, this.minimumFontSize = 1, this.effectsSequence = [], this.currentData = {
							ascent: 0,
					...
					f([fi, yi, xi, Ti, wi, di, Di], Yi), Yi.prototype.initSecondaryElement = function() {}, Yi.prototype.identityMatrix = new jt, Yi.prototype.buildExpressionInterface = function() {}, Yi.prototype.createContent = function() {
						...
						var o, h, l, p, f, d, m = [].concat(r),
							c = t.length - 1,
							u = [],
							g = [];
						for (o = c; o >= 0; o -= 1) {
							if ((d = this.searchProcessedElement(t[o])) ? e[o] = i[d - 1] : t[o]._render = n, "fl" === t[o].ty || "st" === t[o].ty || "gf" === t[o].ty || "gs" === t[o].ty || "no" === t[o].ty) d ? e[o].style.closed = !1 : e[o] = this.createStyleElement(t[o], a), t[o]._render && e[o].style.pElem.parentNode !== s && s.appendChild(e[o].style.pElem), u.push(e[o].style);
							else if ("gr" === t[o].ty) {
								if (d)
							...
							} else "tr" === t[o].ty ? (d || (e[o] = this.createTransformElement(t[o], s)), p = e[o].transform, m.push(p)) : "sh" === t[o].ty || "rc" === t[o].ty || "el" === t[o].ty || "sr" === t[o].ty ? (d || (e[o] = this.createShapeElement(t[o], m, a)), this.setElementStyles(e[o])) : "tm" === t[o].ty || "rd" === t[o].ty || "ms" === t[o].ty || "pb" === t[o].ty || "zz" === t[o].ty || "op" === t[o].ty ? (d ? (f = e[o]).closed = !1 : ((f = le.getModifier(t[o].ty)).init(this, t[o]), e[o] = f, this.shapeModifiers.push(f)), g.push(f)) : "rp" === t[o].ty && (d ? (f = e[o]).closed = !0 : (f = le.getModifier(t[o].ty), e[o] = f, f.init(this, t, o, e), this.shapeModifiers.push(f), n = !1), g.push(f));
					...
					}, Gi.prototype.update = function(t, e, i, s, a, r) {
					...
					}, Ji.prototype.defaultBoxWidth = [0, 0], Ji.prototype.copyData = function(t, e) {
						for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (t[i] = e[i]);
						return t
					}, Ji.prototype.setCurrentData = function(t) {
						...
						if (t.sz)
							for (var S, x, w = !0, D = t.sz[0], M = t.sz[1]; w;) {
								S = 0, y = 0, i = (x = this.buildFinalText(t.t)).length, A = t.tr / 1e3 * t.finalSize;
								var C = -1;
								for (e = 0; e < i; e += 1) P = x[e].charCodeAt(0), s = !1, " " === x[e] ? C = e : 13 !== P && 3 !== P || (y = 0, s = !0, S += t.finalLineHeight || 1.2 * t.finalSize), h.chars ? (o = h.getCharData(x[e], b.fStyle, b.fFamily), _ = s ? 0 : o.w * t.finalSize / 100) : _ = h.measureText(x[e], t.f, t.finalSize), y + _ > D && " " !== x[e] ? (-1 === C ? i += 1 : e = C, S += t.finalLineHeight || 1.2 * t.finalSize, x.splice(e, C === e ? 1 : 0, "\r"), C = -1, y = 0) : (y += _, y += A);
								S += b.ascent * t.finalSize / 100, this.canResize && t.finalSize > this.minimumFontSize && M < S ? (t.finalSize -= 1, t.finalLineHeight = t.finalSize * t.lh / t.s) : (t.finalText = x, i = t.finalText.length, w = !1)
							}
						y = -A, _ = 0;
						var T, F = 0;
						for (e = 0; e < i; e += 1)
							if (s = !1, 13 === (P = (T = t.finalText[e]).charCodeAt(0)) || 3 === P ? (F = 0, g.push(y), v = y > v ? y : v, y = -2 * A, a = "", s = !0, u += 1) : a = T, h.chars ? (o = h.getCharData(T, b.fStyle, h.getFontByName(t.f).fFamily), _ = s ? 0 : o.w * t.finalSize / 100) : _ = h.measureText(a, t.f, t.finalSize), " " === T ? F += _ + A : (y += _ + A + F, F = 0), p.push({
									l: _,
									an: _,
									add: m,
									n: s,
						...
						for (r = 0; r < n; r += 1) {
							...
							var O, N = -1;
							if (1 === E.s.rn)
								for (e = 0; e < i; e += 1) N != (I = p[e]).anIndexes[r] && (N = I.anIndexes[r], O = z.splice(Math.floor(Math.random() * z.length), 1)[0]), I.anIndexes[r] = O
						}
					...
					var Ki = function() {
						...
						function s(t, e) {
							this._currentTextLength = -1, this.k = !1, this.data = e, this.elem = t, this.comp = t.comp, this.finalS = 0, this.finalE = 0, this.initDynamicPropertyContainer(t), this.s = Lt.getProp(t, e.s || {
								k: 0
							}, 0, 0, this), this.e = "e" in e ? Lt.getProp(t, e.e, 0, 0, this) : {
								v: 100
							}, this.o = Lt.getProp(t, e.o || {
								k: 0
							}, 0, 0, this), this.xe = Lt.getProp(t, e.xe || {
								k: 0
							}, 0, 0, this), this.ne = Lt.getProp(t, e.ne || {
								k: 0
							}, 0, 0, this), this.sm = Lt.getProp(t, e.sm || {
								k: 100
							}, 0, 0, this), this.a = Lt.getProp(t, e.a, 0, .01, this), this.dynamicProperties.length || this.getValue()
						}
						...
						return s.prototype = {
							getMult: function(s) {
								...
								var h = mt.getBezierEasing(a, r, n, o).get,
									l = 0,
									p = this.finalS,
									f = this.finalE,
									d = this.data.sh;
					...
					function Ui(t, e, i) {
						...
						}, this.s = Ki.getTextSelectorProp(t, e.s, i), this.s.t = e.s.t
					}

					function Zi(t, e, i) {
						this._isFirstFrame = !0, this._hasMaskedPath = !1, this._frameId = -1, this._textData = t, this._renderType = e, this._elem = i, this._animatorsData = u(this._textData.a.length), this._pathData = {}, this._moreOptions = {
							alignment: {}
						}, this.renderedLetters = [], this.lettersChangedFlag = !1, this.initDynamicPropertyContainer(i)
					}

					function Qi() {}
					Zi.prototype.searchProperties = function() {
						var t, e, i = this._textData.a.length,
							s = Lt.getProp;
						for (t = 0; t < i; t += 1) e = this._textData.a[t], this._animatorsData[t] = new Ui(this._elem, e, this);
					...
					}, Zi.prototype.getMeasures = function(t, e) {
						if (this.lettersChangedFlag = e, this._mdf || this._isFirstFrame || e || this._hasMaskedPath && this._pathData.m._mdf) {
							this._isFirstFrame = !1;
							var i, s, a, r, n, o, h, l, p, f, d, m, c, u, g, y, v, b, _, k = this._moreOptions.alignment.v,
							...
							if (this._hasMaskedPath) {
								if (_ = this._pathData.m, !this._pathData.n || this._pathData._mdf) {
									var M, C = _.v;
									for (this._pathData.r.v && (C = C.reverse()), n = {
											tLength: 0,
											segments: []
										}, r = C._length - 1, y = 0, a = 0; a < r; a += 1) M = bt.buildBezierData(C.v[a], C.v[a + 1], [C.o[a][0] - C.v[a][0], C.o[a][1] - C.v[a][1]], [C.i[a + 1][0] - C.v[a + 1][0], C.i[a + 1][1] - C.v[a + 1][1]]), n.tLength += M.segmentLength, n.segments.push(M), y += M.segmentLength;
									a = r, _.v.c && (M = bt.buildBezierData(C.v[a], C.v[0], [C.o[a][0] - C.v[a][0], C.o[a][1] - C.v[a][1]], [C.i[0][0] - C.v[0][0], C.i[0][1] - C.v[0][1]]), n.tLength += M.segmentLength, n.segments.push(M), y += M.segmentLength), this._pathData.pi = n
								}
								if (n = this._pathData.pi, o = this._pathData.f.v, d = 0, f = 1, l = 0, p = !0, u = n.segments, o < 0 && _.v.c)
									for (n.tLength < Math.abs(o) && (o = -Math.abs(o) % n.tLength), f = (c = u[d = u.length - 1].points).length - 1; o < 0;) o += c[f].partialLength, (f -= 1) < 0 && (f = (c = u[d -= 1].points).length - 1);
								m = (c = u[d].points)[f - 1], g = (h = c[f]).partialLength
							}
							r = D.length, i = 0, s = 0;
							var T, F, E, I, L, V = 1.2 * t.finalSize * .714,
								R = !0;
							E = P.length;
							var z, O, N, B, q, H, Y, G, J, K, U, Z, Q = -1,
								$ = o,
								tt = d,
								et = f,
								it = -1,
							...
							if (2 === t.j || 1 === t.j) {
								...
								for (a = 0; a < r; a += 1)
									if (D[a].n) {
										for (rt && (rt += nt); ht < a;) D[ht].animatorJustifyOffset = rt, ht += 1;
										rt = 0, lt = !0
									} else {
										for (F = 0; F < E; F += 1)(T = P[F].a).t.propType && (lt && 2 === t.j && (nt += T.t.v * ot), (L = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)).length ? rt += T.t.v * L[0] * ot : rt += T.t.v * L * ot);
										lt = !1
									} for (rt && (rt += nt); ht < a;) D[ht].animatorJustifyOffset = rt, ht += 1
							}
							for (a = 0; a < r; a += 1) {
								if (S.reset(), B = 1, D[a].n) i = 0, s += t.yOffset, s += R ? 1 : 0, o = $, R = !1, this._hasMaskedPath && (f = et, m = (c = u[d = tt].points)[f - 1], g = (h = c[f]).partialLength, l = 0), st = "", U = "", J = "", Z = "", at = this.defaultPropsArray;
								else {
									if (this._hasMaskedPath) {
										if (it !== D[a].line) {
											switch (t.j) {
										...
										var pt = 0;
										for (F = 0; F < E; F += 1)(T = P[F].a).p.propType && ((L = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)).length ? pt += T.p.v[0] * L[0] : pt += T.p.v[0] * L), T.a.propType && ((L = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)).length ? pt += T.a.v[0] * L[0] : pt += T.a.v[0] * L);
										...
										z = D[a].an / 2 - D[a].add, S.translate(-z, 0, 0)
									} else z = D[a].an / 2 - D[a].add, S.translate(-z, 0, 0), S.translate(-k[0] * D[a].an * .005, -k[1] * V * .01, 0);
									...
									for (t.strokeWidthAnim && (H = t.sw || 0), t.strokeColorAnim && (q = t.sc ? [t.sc[0], t.sc[1], t.sc[2]] : [0, 0, 0]), t.fillColorAnim && t.fc && (Y = [t.fc[0], t.fc[1], t.fc[2]]), F = 0; F < E; F += 1)(T = P[F].a).a.propType && ((L = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars)).length ? S.translate(-T.a.v[0] * L[0], -T.a.v[1] * L[1], T.a.v[2] * L[2]) : S.translate(-T.a.v[0] * L, -T.a.v[1] * L, T.a.v[2] * L));
									...
									for (F = 0; F < E; F += 1) {
										if (T = P[F].a, L = P[F].s.getMult(D[a].anIndexes[F], A.a[F].s.totalChars), T.sk.propType && (L.length ? S.skewFromAxis(-T.sk.v * L[0], T.sa.v * L[1]) : S.skewFromAxis(-T.sk.v * L, T.sa.v * L)), T.r.propType && (L.length ? S.rotateZ(-T.r.v * L[2]) : S.rotateZ(-T.r.v * L)), T.ry.propType && (L.length ? S.rotateY(T.ry.v * L[1]) : S.rotateY(T.ry.v * L)), T.rx.propType && (L.length ? S.rotateX(T.rx.v * L[0]) : S.rotateX(T.rx.v * L)), T.o.propType && (L.length ? B += (T.o.v * L[0] - B) * L[0] : B += (T.o.v * L - B) * L), t.strokeWidthAnim && T.sw.propType && (L.length ? H += T.sw.v * L[0] : H += T.sw.v * L), t.strokeColorAnim && T.sc.propType)
											for (G = 0; G < 3; G += 1) L.length ? q[G] += (T.sc.v[G] - q[G]) * L[0] : q[G] += (T.sc.v[G] - q[G]) * L;
										if (t.fillColorAnim && t.fc) {
											if (T.fc.propType)
												for (G = 0; G < 3; G += 1) L.length ? Y[G] += (T.fc.v[G] - Y[G]) * L[0] : Y[G] += (T.fc.v[G] - Y[G]) * L;
											T.fh.propType && (Y = L.length ? X(Y, T.fh.v * L[0]) : X(Y, T.fh.v * L)), T.fs.propType && (Y = L.length ? j(Y, T.fs.v * L[0]) : j(Y, T.fs.v * L)), T.fb.propType && (Y = L.length ? W(Y, T.fb.v * L[0]) : W(Y, T.fb.v * L))
										}
									}
									...
									if (t.strokeWidthAnim && (J = H < 0 ? 0 : H), t.strokeColorAnim && (K = "rgb(" + Math.round(255 * q[0]) + "," + Math.round(255 * q[1]) + "," + Math.round(255 * q[2]) + ")"), t.fillColorAnim && t.fc && (U = "rgb(" + Math.round(255 * Y[0]) + "," + Math.round(255 * Y[1]) + "," + Math.round(255 * Y[2]) + ")"), this._hasMaskedPath) {
										if (S.translate(0, -t.ls), S.translate(0, k[1] * V * .01 + s, 0), this._pathData.p.v) {
											b = (h.point[1] - m.point[1]) / (h.point[0] - m.point[0]);
											var ft = 180 * Math.atan(b) / Math.PI;
											h.point[0] < m.point[0] && (ft += 180), S.rotate(-ft * Math.PI / 180)
										}
										S.translate(O, N, 0), o -= k[0] * D[a].an * .005, D[a + 1] && Q !== D[a + 1].ind && (o += D[a].an / 2, o += .001 * t.tr * t.finalSize)
									} else {
										...
										S.translate(0, -t.ls), S.translate(z, 0, 0), S.translate(k[0] * D[a].an * .005, k[1] * V * .01, 0), i += D[a].l + .001 * t.tr * t.finalSize
									}
									"html" === x ? st = S.toCSS() : "svg" === x ? st = S.to2dCSS() : at = [S.props[0], S.props[1], S.props[2], S.props[3], S.props[4], S.props[5], S.props[6], S.props[7], S.props[8], S.props[9], S.props[10], S.props[11], S.props[12], S.props[13], S.props[14], S.props[15]], Z = B
								}
								w <= a ? (I = new Gi(Z, J, K, U, st, at), this.renderedLetters.push(I), w += 1, this.lettersChangedFlag = !0) : (I = this.renderedLetters[a], this.lettersChangedFlag = I.update(Z, J, K, U, st, at) || this.lettersChangedFlag)
							}
						}
					}, Zi.prototype.getValue = function() {
						this._elem.globalData.frameId !== this._frameId && (this._frameId = this._elem.globalData.frameId, this.iterateDynamicProperties())
					}, Zi.prototype.mHelper = new jt, Zi.prototype.defaultPropsArray = [], f([Vt], Zi), Qi.prototype.initElement = function(t, e, i) {
						this.lettersChangedFlag = !0, this.initFrame(), this.initBaseData(t, e, i), this.textProperty = new Ji(this, t.t, this.dynamicProperties), this.textAnimator = new Zi(t.t, this.renderType, this), this.initTransform(t, e, i), this.initHierarchy(), this.initRenderable(), this.initRendererElement(), this.createContainerElements(), this.createRenderableComponents(), this.createContent(), this.hide(), this.textAnimator.searchProperties(this.dynamicProperties)
					}, Qi.prototype.prepareFrame = function(t) {
						this._mdf = !1, this.prepareRenderableFrame(t), this.prepareProperties(t, this.isInRange)
					}, Qi.prototype.createPathShape = function(t, e) {
						var i, s, a = e.length,
							r = "";
						for (i = 0; i < a; i += 1) "sh" === e[i].ty && (s = e[i].ks.k, r += Xi(s, s.i.length, !0, t));
						return r
					}, Qi.prototype.updateDocumentData = function(t, e) {
						this.textProperty.updateDocumentData(t, e)
					}, Qi.prototype.canResizeFont = function(t) {
						this.textProperty.canResizeFont(t)
					}, Qi.prototype.setMinimumFontSize = function(t) {
						this.textProperty.setMinimumFontSize(t)
					}, Qi.prototype.applyTextPropertiesToMatrix = function(t, e, i, s, a) {
						...
						e.translate(s, a, 0)
					}, Qi.prototype.buildColor = function(t) {
						return "rgb(" + Math.round(255 * t[0]) + "," + Math.round(255 * t[1]) + "," + Math.round(255 * t[2]) + ")"
					}, Qi.prototype.emptyProp = new Gi, Qi.prototype.destroy = function() {}, Qi.prototype.validateText = function() {
					...
					function rs(t, e, i) {
						this.layers = t.layers, this.supports3d = !0, this.completeLayers = !1, this.pendingElements = [], this.elements = this.layers ? u(this.layers.length) : [], this.initElement(t, e, i), this.tm = t.tm ? Lt.getProp(this, t.tm, 0, e.frameRate, this) : {
							_placeholder: !0
						}
					}
					...
					return f([fi, yi, xi, wi, di, Di, Qi], ts), ts.prototype.createContent = function() {
						...
						this.renderedLetters = u(i ? i.l.length : 0), i.fc ? this.layerElement.setAttribute("fill", this.buildColor(i.fc)) : this.layerElement.setAttribute("fill", "rgba(0,0,0,0)"), i.sc && (this.layerElement.setAttribute("stroke", this.buildColor(i.sc)), this.layerElement.setAttribute("stroke-width", i.sw)), this.layerElement.setAttribute("font-size", i.finalSize);
						...
						if (!f || h || i.sz) {
							...
							for (t = 0; t < e; t += 1) {
								if (this.textSpans[t] || (this.textSpans[t] = {
									...
									if (n = v > t ? this.textSpans[t].span : $(h ? "g" : "text"), v <= t) {
										if (n.setAttribute("stroke-linecap", "butt"), n.setAttribute("stroke-linejoin", "round"), n.setAttribute("stroke-miterlimit", "4"), this.textSpans[t].span = n, h) {
											var b = $("g");
											n.appendChild(b), this.textSpans[t].childSpan = b
										}
										this.textSpans[t].span = n, this.layerElement.appendChild(n)
									}
									n.style.display = "inherit"
								}
								if (l.reset(), f && (o[t].n && (d = -g, m += i.yOffset, m += c ? 1 : 0, c = !1), this.applyTextPropertiesToMatrix(i, l, o[t].line, d, m), d += o[t].l || 0, d += g), h) {
									var _;
									if (1 === (y = this.globalData.fontManager.getCharData(i.finalText[t], s.fStyle, this.globalData.fontManager.getFontByName(i.f).fFamily)).t) _ = new rs(y.data, this.globalData, this);
									else {
										var k = $i;
										y.data && y.data.shapes && (k = this.buildShapeData(y.data, i.finalSize)), _ = new Yi(k, this.globalData, this)
									}
									if (this.textSpans[t].glyph) {
										var P = this.textSpans[t].glyph;
										this.textSpans[t].childSpan.removeChild(P.layerElement), P.destroy()
									}
									this.textSpans[t].glyph = _, _._debug = !0, _.prepareFrame(0), _.renderFrame(), this.textSpans[t].childSpan.appendChild(_.layerElement), 1 === y.t && this.textSpans[t].childSpan.setAttribute("transform", "scale(" + i.finalSize / 100 + "," + i.finalSize / 100 + ")")
								} else f && n.setAttribute("transform", "translate(" + l.props[12] + "," + l.props[13] + ")"), n.textContent = o[t].val, n.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve")
							}
							f && n && n.setAttribute("d", p)
						} else {
							...
							A.setAttribute("text-anchor", S), A.setAttribute("letter-spacing", g);
							var x = this.buildTextContents(i.finalText);
							for (e = x.length, m = i.ps ? i.ps[1] + i.ascent : 0, t = 0; t < e; t += 1)(n = this.textSpans[t].span || $("tspan")).textContent = x[t], n.setAttribute("x", 0), n.setAttribute("y", m), n.style.display = "inherit", A.appendChild(n), this.textSpans[t] || (this.textSpans[t] = {
								span: null,
								glyph: null
					...
					}, f([Mi], es), es.prototype.createContent = function() {
						var t = $("rect");
						...
						return null
					}, is.prototype.destroy = function() {}, is.prototype.sourceRectAtTime = function() {}, is.prototype.hide = function() {}, f([fi, yi, wi, di], is), f([ui], ss), ss.prototype.createNull = function(t) {
						...
						var a = N();
						i.setAttribute("id", a), i.appendChild(s), this.layerElement.setAttribute("clip-path", "url(" + l() + "#" + a + ")"), e.appendChild(i), this.layers = t.layers, this.elements = u(t.layers.length)
					...
					}, f([fi, yi, wi, di, Di], as), as.prototype.initElement = function(t, e, i) {
						this.initFrame(), this.initBaseData(t, e, i), this.initTransform(t, e, i), this.initRenderable(), this.initHierarchy(), this.initRendererElement(), this.createContainerElements(), this.createRenderableComponents(), !this.data.xt && e.progressiveLoad || this.buildAllItems(), this.hide()
					}, as.prototype.prepareFrame = function(t) {
					...
					}, as.prototype.renderInnerContent = function() {
						var t, e = this.layers.length;
						for (t = 0; t < e; t += 1)(this.completeLayers || this.elements[t]) && this.elements[t].renderFrame()
					}, as.prototype.setElements = function(t) {
						this.elements = t
					}, as.prototype.getElements = function() {
						return this.elements
					}, as.prototype.destroyElements = function() {
						var t, e = this.layers.length;
						for (t = 0; t < e; t += 1) this.elements[t] && this.elements[t].destroy()
					}, as.prototype.destroy = function() {
						this.destroyElements(), this.destroyBaseElement()
					}, f([ss, as, xi], rs), rs.prototype.createComp = function(t) {
						return new rs(t, this.globalData, this)
					}, f([ss], ns), ns.prototype.createComp = function(t) {
						return new rs(t, this.globalData, this)
					}, ot("svg", ns), le.registerModifier("tm", fe), le.registerModifier("pb", de), le.registerModifier("rp", ce), le.registerModifier("rd", ue), le.registerModifier("zz", Le), le.registerModifier("op", Ge), Xt
				}())
			}
		},
		e = {};
	...
	i.amdO = {}, i.n = t => {
		...
		document.addEventListener("DOMContentLoaded", (function(t) {
			document.getElementById("lottieIntro") && setTimeout((function() {
				e().loadAnimation({
			...
			}), 800), document.getElementById("lottieDragonfly") && e().loadAnimation({
				container: document.getElementById("lottieDragonfly"),
				renderer: "svg",
				loop: !0,
				autoplay: !0,
				path: "json/dragonfly.json"
			})
		}))
	})()
})();